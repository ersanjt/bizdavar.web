#!/usr/bin/env python3
"""Download UWT Solido 500 product image from sensors.com.tr."""
...
OUT = ROOT / "assets" / "images" / "uwt" / "product-solido500.png"
PAGE = "https://www.sensors.com.tr/urun/uwt-solido500-laa-24v-seviye-salteri"
...
def main() -> None:
    ...
    for src in candidates:
        ...
        if any(x in low for x in ("logo", "icon", "sprite", "placeholder", "banner")):
            continue
        if "solido" in low or "uwt" in low or "/urun" in low or "/uploads" in low or "/data/" in low:
            picked = src
            break
