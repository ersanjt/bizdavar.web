 ...
 * تنظیمات مرکزی سایت — مقادیر تماس را اینجا به‌روز کنید

 * منبع: بکاپ bizdavar.com + fast.bizdavar.com
...
window.BIZDAVAR_CONFIG = {
  ...
  seo: {
    ...
    ogImage: 'assets/images/about-us-1320x682.jpg',
  ...
  services: [
    ...
    { id: 'digital-marketing', title: 'بازاریابی دیجیتال', slug: 'services.html#digital-marketing' },

    { id: 'web-design', title: 'طراحی و توسعه وب', slug: 'fast.html' },

    { id: 'smm', title: 'مدیریت SMM', slug: 'services.html#smm' },

    { id: 'industrial', title: 'تامین تجهیزات صنعتی', slug: 'services.html#industrial' }
  ...
  blogPosts: [

    {
      ...
      slug: 'article-digital-marketing.html',
      ...
      relatedService: 'services.html#digital-marketing'

    },

    {

      slug: 'article-fast-studio.html',
      ...
      relatedService: 'fast.html'

    },

    {

      slug: 'article-industrial-sensors.html',
      ...
      relatedService: 'services.html#industrial'
  ...
  processSteps: [
    {
      ...
      desc: 'بررسی اهداف کسب‌وکار، مخاطب هدف و اولویت‌های دیجیتال — مشاوره اولیه رایگان.'
    },
    {
      num: '۰۲',
      title: 'طراحی راهکار',
      desc: 'تدوین استراتژی، انتخاب پلتفرم و برنامه اجرایی متناسب با بودجه و زمان‌بندی.'
    },
    {
      num: '۰۳',
      title: 'اجرا و تحویل',
      desc: 'پیاده‌سازی حرفه‌ای — از کمپین دیجیتال تا سایت و تامین تجهیزات صنعتی.'
    },
    {
      num: '۰۴',
      title: 'پشتیبانی و رشد',
      desc: 'بهینه‌سازی مستمر، گزارش‌دهی شفاف و همراهی بلندمدت برای رشد پایدار.'
    }
  ],
  ...
  portfolio: [
    ...
    { name: 'Fast Web Studio', domain: 'fast.bizdavar.com', category: 'طراحی سایت', internal: true, slug: 'fast.html' }
...
window.getWhatsappUrl = function (message) {
  ...
  if (!C || !C.contact.whatsapp) return 'contact.html';
...
window.getProjectUrl = function (project) {
  ...
  if (project.internal && project.slug) return project.slug;
