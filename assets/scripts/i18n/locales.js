...
window.BIZDAVAR_LOCALES = {
  fa: {
    ...
    nav: {
      ...
      serviceFieldFeaturedDesc: 'تبریز و استانبول — مهندس آرشام جاهد تبریزی',
  ...
  tr: {
    ...
    nav: {
      ...
      serviceFieldFeaturedDesc: 'Tebriz ve İstanbul — Müh. Arsham Jahed Tabrizi',
  ...
  en: {
    ...
    nav: {
      ...
      serviceFieldFeaturedDesc: 'Tabriz and Istanbul — Eng. Arsham Jahed Tabrizi',
