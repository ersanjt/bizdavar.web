...
window.BIZDAVAR_LOCALES = {
  ...
  tr: {
    ...
    industrial: {
      ...
      visualNote: 'Modeli söyleyin — Farsça teklif ve İran’a lojistik.',
      step1: 'Model seçimi',
      step2: 'Farsça teklif',
      step3: 'İran’a teslim',
      products: [
    ...
    contactPage: {
      ...
      geoText: 'İran, Türkiye, Ermenistan ve Dubai ofislerinden danışmanlık — Türkçe ve Farsça WhatsApp.',
  ...
  en: {
    ...
    industrial: {
      ...
      visualNote: 'Name the model — Persian proforma and logistics to the Iran site.',
      step1: 'Select the model',
      step2: 'Persian proforma',
      step3: 'Delivery to Iran',
      products: [
    ...
    contactPage: {
      ...
      geoText: 'Consulting from offices in Iran, Turkey, Armenia and Dubai — Persian and Turkish WhatsApp.',
