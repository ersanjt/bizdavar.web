...
window.BIZDAVAR_LOCALES = {
  fa: {
    ...
    supplyBrand: {
      ...
      navIran: 'صنایع ایران',
      navFaq: 'سوالات',
      navAria: 'دسته‌بندی محصولات VEGA',
    ...
    nav: {
      ...
      productsLines: 'خطوط و کاتالوگ',
      productsMegaHint: 'محصولات مالکیتی تیم بیزدوار',
      productsSupplyLink: 'تامین برندهای صنعتی',
      productsSupplyDesc: 'VEGA · Prosense · Liqui Moly',
  ...
  tr: {
    ...
    supplyBrand: {
      ...
      navFaq: 'SSS',
      navAria: 'VEGA ürün kategorileri',
    ...
    nav: {
      ...
      productsLines: 'Hatlar ve katalog',
  ...
  en: {
    ...
    supplyBrand: {
      ...
      navFaq: 'FAQ',
      navAria: 'VEGA product categories',
