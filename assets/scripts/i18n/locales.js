...
window.BIZDAVAR_LOCALES = {
  fa: {
    ...
    home: {
      ...
      leadPaths: [
        { icon: 'bolt', title: 'سایت و فروش آنلاین', desc: 'Fast Web Studio — از $99، تحویل ۵ روز، واتساپ و فرم لید', cta: 'مشاهده پلن‌ها', url: '/pages/fast' },
        { icon: 'wrench', title: 'تامین صنعتی', desc: 'VEGA، Prosense، UWT و Liqui Moly — استعلام با مشاوره فنی فارسی', cta: 'درخواست استعلام', url: '/pages/contact?service=industrial' },
        { icon: 'message', title: 'مشاوره رایگان', desc: 'وب، مارکتینگ، FXGuard CRM یا پروژه اختصاصی — بدون تعهد', cta: 'تماس با ما', url: '/pages/contact' }
      ],
  ...
  tr: {
    ...
    home: {
      ...
      leadPaths: [
        { icon: 'bolt', title: 'Web ve online satış', desc: 'Fast Web Studio — $99\'dan, 5 günde teslim, WhatsApp ve lead formu', cta: 'Planları gör', url: '/tr/pages/fast' },
        { icon: 'wrench', title: 'Endüstriyel tedarik', desc: 'VEGA, Prosense, UWT, Liqui Moly — teknik danışmanlıkla teklif', cta: 'Teklif iste', url: '/tr/pages/contact?service=industrial' },
        { icon: 'message', title: 'Ücretsiz danışmanlık', desc: 'Web, pazarlama, FXGuard CRM veya özel proje — taahhütsüz', cta: 'İletişim', url: '/tr/pages/contact' }
      ],
  ...
  en: {
    ...
    home: {
      ...
      leadPaths: [
        { icon: 'bolt', title: 'Website & online sales', desc: 'Fast Web Studio — from $99, 5-day delivery, WhatsApp & lead forms', cta: 'View plans', url: '/en/pages/fast' },
        { icon: 'wrench', title: 'Industrial supply', desc: 'VEGA, Prosense, UWT, Liqui Moly — quote with technical consulting', cta: 'Request quote', url: '/en/pages/contact?service=industrial' },
        { icon: 'message', title: 'Free consultation', desc: 'Web, marketing, FXGuard CRM or custom project — no commitment', cta: 'Contact us', url: '/en/pages/contact' }
      ],
