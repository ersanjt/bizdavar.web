  ...
  fa: {
    ...
    common: {
      ...
      offerMap: {
        ...
        lead: 'به چه چیزی نیاز دارید؟',
        servicesNum: '۰۱',
        servicesTitle: 'خدمات',
        servicesDesc: 'سایت ۵روزه، بازاریابی دیجیتال، SMM، اپ، سرور و خدمات فنی',
        ...
        supplyDesc: 'قطعات صنعتی و ابزار دقیق: دتکتور Prosense، سنسور VEGA و سایر برندها — برای استعلام قیمت با ما در ارتباط باشید',
        supplyGo: 'استعلام قیمت'
      }
    },
    supplyBrand: {
    ...
    contactPage: {
      ...
      heroTitle: 'استعلام قیمت VEGA، Prosense یا طراحی سایت',
      heroDesc: 'واتساپ سریع‌ترین راه است. شماره واتساپ کافی است — ایمیل اختیاری.',
  ...
  tr: {
    ...
    common: {
      ...
      offerMap: {
        ...
        lead: 'Neye ihtiyacınız var?',
        servicesNum: '01',
        servicesTitle: 'Hizmetler',
        servicesDesc: '5 günde site, dijital pazarlama, SMM, uygulama, sunucu ve teknik hizmet',
        ...
        supplyDesc: 'Endüstriyel parça ve enstrümantasyon: Prosense gaz dedektörü, VEGA sensör ve diğer markalar — fiyat için bize yazın',
        supplyGo: 'Fiyat sorun'
      }
    },
    supplyBrand: {
    ...
    contactPage: {
      ...
      heroTitle: 'VEGA, Prosense veya web sitesi teklifi',
      heroDesc: 'WhatsApp en hızlı yoldur. WhatsApp numarası yeterli — e-posta isteğe bağlı.',
      formTitle: 'İletişim talep formu',
      formDesc: 'Ad ve WhatsApp zorunlu. E-posta isteğe bağlı.',
  ...
  en: {
    ...
    common: {
      ...
      offerMap: {
        ...
        servicesDesc: '5-day websites, digital marketing, SMM, apps, servers and technical services',
        ...
        supplyDesc: 'Industrial parts and instrumentation: Prosense detectors, VEGA sensors and other brands — contact us for a quote',
        supplyGo: 'Request a quote'
      }
    },
    supplyBrand: {
    ...
    contactPage: {
      ...
      heroTitle: 'Quote for VEGA, Prosense or a new website',
      heroDesc: 'WhatsApp is the fastest path. A WhatsApp number is enough — email is optional.',
      formTitle: 'Contact request form',
      formDesc: 'Name and WhatsApp are required. Email is optional.',
