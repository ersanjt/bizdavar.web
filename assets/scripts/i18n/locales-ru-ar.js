...
(function () {
  ...
  var pageSeoRu = {
    ...
    autoMoto: {
      crumb: 'Мото и тормоза',
      h1: 'Auto-Moto',
      lead: 'Это два разных магазина. Экипировку берите в мотомагазине, колодки и диски — в магазине тормозов.',
      motoTitle: 'Магазин мотоэкипировки',
      motoDesc: 'Шлемы, куртки, перчатки, штаны, ботинки, интеркомы и защита. Цена на карточке в долларах, с доставкой в Иран.',
      motoHelmet: 'Шлемы',
      motoJacket: 'Куртки',
      motoBoots: 'Ботинки',
      motoCta: 'Открыть мотомагазин',
      motoAlt: 'Логотип мотомагазина Bizdavar',
      brakeTitle: 'Магазин тормозов',
      brakeDesc: 'Колодки и диски подбираются по марке и модели автомобиля.',
      brakePads: 'Колодки',
      brakeDiscs: 'Диски',
      brakeFluid: 'Жидкость',
      brakeCta: 'Открыть магазин тормозов',
      brakeAlt: 'Логотип магазина тормозов Bizdavar',
      seoTitle: 'Auto-Moto | мотоэкипировка и тормозные детали | Bizdavar',
      seoDescription: 'Два отдельных магазина. Мотоэкипировка стоит в долларах с доставкой в Иран. В магазине тормозов колодки и диски подбирают по марке и модели автомобиля.',
      seoKeywords: 'Auto-Moto, мотоэкипировка, тормозные колодки, тормозные диски, Bizdavar'
    },
    motorcycle: {
      ...
      seoTitle: 'Мотоэкипировка | шлем, куртка, мотоботы | Bizdavar',
      seoDescription: 'Каталог мотоэкипировки Bizdavar: шлемы, куртки, перчатки, мотоботы, интерком и защита. Цена на карточке — в долларах США, с доставкой в Иран. Если цены нет — только запрос.',
    ...
    carParts: {
      ...
      seoDescription: 'Магазин тормозов Bizdavar: колодки, диски, спорт и жидкость. Цена на карточке — USD с доставкой в Иран.',
  ...
  var pageSeoAr = {
    ...
    autoMoto: {
      crumb: 'دراجات نارية وفرامل',
      h1: 'أوتو-موتو',
      lead: 'هذان متجران منفصلان. خذوا معدات الدراجة النارية من متجر الدراجات النارية، والفحمات والأقراص من متجر الفرامل.',
      motoTitle: 'متجر الدراجات النارية',
      motoDesc: 'خوذات وسترات وقفازات وبناطيل وبوت وإنتركم وحماية. السعر على البطاقة بالدولار، لتسليم إيران.',
      motoHelmet: 'خوذة',
      motoJacket: 'سترة',
      motoBoots: 'بوت',
      motoCta: 'ادخلوا متجر الدراجات النارية',
      motoAlt: 'شعار متجر الدراجات النارية في بيزدوار',
      brakeTitle: 'متجر الفرامل',
      brakeDesc: 'اختاروا فحمات وأقراص الفرامل حسب ماركة السيارة وموديلها.',
      brakePads: 'فحمات',
      brakeDiscs: 'أقراص',
      brakeFluid: 'سائل الفرامل',
      brakeCta: 'ادخلوا متجر الفرامل',
      brakeAlt: 'شعار متجر الفرامل في بيزدوار',
      seoTitle: 'أوتو-موتو | معدات دراجات نارية وقطع فرامل | Bizdavar',
      seoDescription: 'متجران منفصلان. معدات الدراجة النارية سعرها بالدولار لتسليم إيران. في متجر الفرامل تُختار الفحمات والأقراص حسب ماركة السيارة وموديلها.',
      seoKeywords: 'أوتو-موتو, معدات دراجات نارية, فحمات فرامل, أقراص فرامل, Bizdavar'
    },
    motorcycle: {
      crumb: 'معدات الدراجات النارية',
      ...
      seoTitle: 'معدات الدراجات النارية | خوذة وسترة وبوت | Bizdavar',
      seoDescription: 'كتالوج معدات الدراجات النارية من بيزدوار: خوذات وسترات وقفازات وبوت وإنتركم وحماية. السعر على البطاقة بالدولار الأمريكي لتسليم إيران. إن لم يوجد سعر فالاستعلام فقط.',
      seoKeywords: 'معدات دراجات نارية, خوذة دراجة نارية, سترة دراجة نارية, بوت دراجة نارية, إنتركم, بيزدوار'
    },
    carParts: {
      crumb: 'فرامل',
      seoTitle: 'فحمات وأقراص الفرامل | اختر الماركة | Bizdavar',
      seoDescription: 'متجر فرامل بيزدوار: فحمات وأقراص وسوائل مع اختيار الماركة والموديل. السعر بالدولار لتسليم إيران.',
  ...
  var homeRu = {
    ...
    heroDesc: 'Сайты Fast Web Studio, цифровой маркетинг, FXGuard, поставки VEGA, Gamak, Teltonika, мотоэкипировка и автозапчасти — офисы в Иране, Турции, Армении и Дубае.',
    ...
    intentMoto: 'Мотоэкипировка',
    intentCar: 'Автозапчасти',
    intentOstrich: 'Страусиная кожа',
    ...
    leadPaths: [
      ...
      { icon: 'factory', title: 'Промышленные поставки', desc: 'VEGA, Gamak, Teltonika, мотоэкипировка и автозапчасти — запрос с техконсультацией', cta: 'Промышленный запрос', url: '/ru/pages/contact?service=industrial' },
    ...
    featIndustrialDesc: 'VEGA, Gamak, Teltonika, мотоэкипировка и автозапчасти',
    ...
    svcIndDesc: 'Датчики VEGA, двигатели Gamak, мотоэкипировка и автозапчасти — техконсультация.',
    ...
    faqs: [
      ...
      { q: 'Какие промышленные бренды вы поставляете?', a: 'VEGA, UWT, Prosense, Liqui Moly, Gamak, Teraoka, мотоэкипировка, автозапчасти и иранская страусиная кожа.' }
    ]
  };
  ...
  var homeAr = {
    ...
    heroTitleEnd: 'ذكية',
    heroDesc: 'مواقع Fast Web Studio وتسويق رقمي وFXGuard وتوريد VEGA وGamak وTeltonika ومعدات الدراجات وقطع السيارات — مكاتب في إيران وتركيا وأرمينيا ودبي.',
    ...
    intentMoto: 'معدات الدراجات النارية',
    intentCar: 'قطع السيارات',
    intentOstrich: 'جلد النعام',
    ...
    leadPaths: [
      ...
      { icon: 'factory', title: 'توريد صناعي', desc: 'VEGA وGamak وTeltonika ومعدات الدراجات وقطع السيارات — عرض سعر مع استشارة فنية', cta: 'استعلام صناعي', url: '/ar/pages/contact?service=industrial' },
    ...
    featIndustrialDesc: 'VEGA وGamak وTeltonika ومعدات الدراجات وقطع السيارات',
    ...
    svcIndDesc: 'حساسات VEGA ومحركات Gamak ومعدات الدراجات وقطع السيارات مع استشارة فنية.',
    ...
    faqs: [
      ...
      { q: 'ما العلامات الصناعية التي تورّدونها؟', a: 'VEGA وUWT وProsense وLiqui Moly وGamak وTeraoka ومعدات الدراجات وقطع السيارات وجلد النعام الإيراني.' }
    ]
  };
  ...
  var homeSectionsRu = {
    ...
    industrial: {
      ...
      products: [
        ...
        { name: 'Auto-Moto', title: 'Мотоэкипировка', desc: 'Шлемы, куртки, перчатки, штаны, ботинки, интеркомы и защита — цена на карточке в долларах с доставкой в Иран', badge: 'Новое', tags: ['Шлемы', 'Куртки', 'Ботинки'], cta: 'Каталог и запрос' },
        { name: 'Car Parts', title: 'Колодки и диски', desc: 'Колодки, диски и тормозные детали по марке и модели — цена в USD с доставкой', badge: 'Новое', tags: ['Колодки', 'Диски', 'Оригинал'], cta: 'Магазин тормозов' },
        { name: 'Ostrich', title: 'Страусиная кожа', desc: 'Выделываем в Иране, от сырья до кожи, готовой к раскрою. Краст от $6.50 за квадратный фут, окрашенная от $8.50, нога от $6.', badge: 'Иран', tags: ['Краст', 'Окрашенная', 'Нога'], cta: 'Оптовый каталог' }
      ]
    }
  };
  ...
  var homeSectionsAr = {
    ...
    industrial: {
      ...
      products: [
        ...
        { name: 'Auto-Moto', title: 'معدات الدراجات النارية', desc: 'خوذات وسترات وقفازات وبوت وإنتركم وحماية. السعر على البطاقة بالدولار لتسليم إيران.', badge: 'جديد', tags: ['خوذة', 'سترة', 'بوت'], cta: 'الكتالوج والاستعلام' },
        { name: 'Car Parts', title: 'فحمات وأقراص الفرامل', desc: 'فحمات وأقراص وقطع فرامل حسب الماركة والموديل — السعر بالدولار', badge: 'جديد', tags: ['فحمات', 'أقراص', 'أصلي'], cta: 'متجر الفرامل' },
        { name: 'Ostrich', title: 'جلد النعام', desc: 'ندبغ هذا الجلد في إيران، من الجلد الخام حتى يصبح جاهزًا للقص. الكراست من 6.5 دولار للقدم المربع، والمصبوغ من 8.5، والساق من 6 دولارات.', badge: 'إيران', tags: ['كراست', 'مصبوغ', 'ساق'], cta: 'كتالوج الجملة' }
      ]
    }
  };
  ...
  deepMerge(ru.nav, {
    ...
    brandAutoMotoDesc: 'Два магазина: мотоэкипировка и тормоза',
    brandAutoMotoBadge: 'Новое',
    autoMotoShop: 'Магазин мотоэкипировки',
    autoMotoShopDesc: 'Шлемы, куртки и боты',
    autoCarShop: 'Магазин тормозов',
    autoCarShopDesc: 'Колодки и диски',
  ...
  ru.autoMotoPage = {
    sections: {
      trust: { eyebrow: 'Почему Bizdavar', title: 'Полный каталог мотоэкипировки', desc: 'Цена на карточке — в долларах США, с доставкой в Иран. Если цены нет, товар только по запросу.' },
      buy: { eyebrow: 'Путь покупки', title: 'От выбора до отправки — пять шагов', desc: 'Стоимость товара отдельно, почта отдельно. Обе суммы — в проформе до оплаты.' },
      quote: { eyebrow: 'Как запросить', title: 'Пришлите размер или артикул', desc: 'Для одежды достаточно размера, роста и веса — проформа выходит быстрее.' },
      highlights: { eyebrow: 'Хиты', title: 'От шлема до туристических мотобот', desc: 'Цена в долларах США, доставка в Иран. Нет цены — только запрос.' },
      catalog: { eyebrow: 'Каталог', title: 'Мотоэкипировка', desc: '3876 мототоваров с живыми фото: шлемы, куртки, перчатки, брюки, мотоботы и интерком.' },
      iran: { eyebrow: 'Для кого', title: 'Кому подходит', desc: 'Мотомагазин, городской райдер, оффроуд и частный заказ.', note: 'Нет размера? Пришлите рост и вес в WhatsApp.' },
      supply: { eyebrow: 'Поставка Bizdavar', title: 'Сервис мотомагазина', desc: 'Один контакт для шлемов, курток, мотобот и остальной экипировки.' },
      faq: { eyebrow: 'Вопросы', title: 'Цена, почта и размер', desc: 'Нет ответа? Напишите в WhatsApp.' }
    },
    officialNote: 'Цена на карточке — в долларах США, с доставкой в Иран. Нет цены — только запрос. Немецкие масла — <a href="liqui-moly">Liqui Moly</a> · <a href="auto-moto">Auto-Moto</a> · <a href="car-parts">магазин тормозов</a> · <a href="contact">контакты</a>',
    cta: { title: 'Нужна цена на шлем, куртку или мотоботы?', desc: 'Пришлите размер или артикул. Придёт проформа; почта подтверждается после заказа.', btnForm: 'Форма запроса', btnServices: 'Каталог' },
    sticky: { label: 'Запрос мотоэкипировки', hint: 'Доллары США, доставка в Иран' },
    geoText: 'Поставка мотоэкипировки — цена на карточке в долларах США, с доставкой в Иран.',
    related: [{ title: 'Auto-Moto', desc: 'Два магазина: экипировка и тормоза' }, { title: 'Магазин тормозов', desc: 'Колодки и диски по марке и модели' }, { title: 'Liqui Moly', desc: 'Масла и присадки' }, { title: 'Контакты', desc: 'Размер одежды или артикул' }]
  };
  ...
  deepMerge(ar.nav, {
    ...
    brandGroupAuto: 'سيارات ودراجات نارية',
    ...
    productAutoMoto: 'Auto-Moto',
    brandAutoMotoDesc: 'متجران: معدات دراجات نارية وفرامل',
    brandAutoMotoBadge: 'جديد',
    autoMotoShop: 'متجر الدراجات النارية',
    autoMotoShopDesc: 'خوذة وسترة وبوت',
    autoCarShop: 'متجر الفرامل',
    autoCarShopDesc: 'فحمات وأقراص',
  ...
  ar.autoMotoPage = {
    sections: {
      trust: { eyebrow: 'لماذا بيزدوار', title: 'كتالوج كامل لمعدات الدراجات النارية', desc: 'السعر على البطاقة بالدولار الأمريكي لتسليم إيران. إن لم يوجد سعر فالاستعلام فقط.' },
      buy: { eyebrow: 'مسار الشراء', title: 'من الاختيار إلى الإرسال — خمس خطوات', desc: 'مبلغ السلعة منفصل والشحن منفصل. كلاهما في الفاتورة المبدئية قبل الدفع.' },
      quote: { eyebrow: 'دليل الاستعلام', title: 'أرسلوا المقاس أو رمز المنتج', desc: 'للملابس يكفي المقاس والطول والوزن — الفاتورة المبدئية أسرع.' },
      highlights: { eyebrow: 'الأكثر طلباً', title: 'من الخوذة إلى بوت التورينغ', desc: 'السعر بالدولار الأمريكي لتسليم إيران. بلا سعر يعني استعلام فقط.' },
      catalog: { eyebrow: 'الكتالوج الكامل', title: 'معدات الدراجات النارية', desc: '٣٨٧٦ منتج للدراجات النارية بصور حقيقية: خوذات وسترات وقفازات وبناطيل وبوت وإنتركم.' },
      iran: { eyebrow: 'الاستخدام', title: 'لمن؟', desc: 'متجر دراجات نارية وراكب مدينة وأوف رود وطلب شخصي.', note: 'لا يوجد مقاس؟ أرسلوا الطول والوزن عبر واتساب.' },
      supply: { eyebrow: 'توريد بيزدوار', title: 'خدمات متجر الدراجات النارية', desc: 'جهة اتصال واحدة للخوذات والسترات والبوت وبقية المعدات.' },
      faq: { eyebrow: 'أسئلة', title: 'السعر والشحن والمقاس', desc: 'لا جواب؟ راسلوا واتساب.' }
    },
    officialNote: 'السعر على البطاقة بالدولار الأمريكي لتسليم إيران. بلا سعر يعني استعلام فقط. لزيوت ألمانيا راجعوا <a href="liqui-moly">Liqui Moly</a> · <a href="auto-moto">أوتو-موتو</a> · <a href="car-parts">متجر الفرامل</a> · <a href="contact">اتصلوا بنا</a>',
    cta: { title: 'هل تريدون استعلاماً عن خوذة أو سترة أو بوت؟', desc: 'أرسلوا المقاس أو رمز SKU. تصلكم فاتورة مبدئية؛ الشحن يُؤكد بعد الطلب.', btnForm: 'نموذج استعلام', btnServices: 'الكتالوج' },
    sticky: { label: 'استعلام معدات الدراجة النارية', hint: 'دولار أمريكي، تسليم إيران' },
    geoText: 'توريد معدات الدراجات النارية — السعر على البطاقة بالدولار الأمريكي لتسليم إيران.',
    related: [{ title: 'أوتو-موتو', desc: 'متجران منفصلان: المعدات والفرامل' }, { title: 'متجر الفرامل', desc: 'فحمات وأقراص حسب الماركة والموديل' }, { title: 'Liqui Moly', desc: 'زيوت وإضافات' }, { title: 'اتصلوا بنا', desc: 'مقاس الملابس أو رمز المنتج' }]
  };
