  ...
  const page = {
    fa: {
      ...
      autoMotoPage: { sections: {
        trust: { eyebrow: 'چرا از بیزدوار بخرید؟', title: 'کاتالوگ کامل تجهیزات موتورسیکلت', desc: 'قیمت روی کارت دلاری تحویل ایران است (لیر ÷ ۴۸ + ۲۰٪). اگر قیمت نباشد فقط استعلام است.' },
        buy: { eyebrow: 'مسیر خرید', title: 'از انتخاب محصول تا ارسال — ۵ مرحله', desc: 'استعلام کالا جدا، پست جدا — هر دو قبل از پرداخت در پیش‌فاکتور می‌آید.' },
        quote: { eyebrow: 'راهنمای استعلام', title: 'سایز لباس یا کد SKU را بفرستید', desc: 'سایز، قد و وزن برای لباس — پیش‌فاکتور سریع‌تر آماده می‌شود.' },
        highlights: { eyebrow: 'محصولات پرتقاضا', title: 'از کلاه ایمنی تا بوت تورینگ', desc: 'قیمت دلاری تحویل ایران. اگر قیمت نباشد استعلام.' },
        ...
        iran: { eyebrow: 'کاربرد', title: 'برای چه کسانی است؟', desc: 'فروشگاه موتور، سوار شهری، آفرود و سفارش شخصی.', note: 'سایز نیست؟ قد و وزن را در واتساپ بفرستید.' },
        supply: { eyebrow: 'تامین از بیزدوار', title: 'خدمات تامین اتو‌موتو', desc: 'یک نقطه تماس فارسی برای تجهیزات موتورسیکلت.' },
        faq: { eyebrow: 'سوالات متداول', title: 'قیمت، پست و سایز', desc: 'پاسخ را پیدا نکردید؟ در واتساپ پیام بدهید.' }
      }, officialNote: 'قیمت روی کارت دلاری تحویل ایران است (لیر فهرست ÷ ۴۸ + ۲۰٪). لیر نمایش داده نمی‌شود. اگر قیمت نباشد استعلام است. برای روغن موتور آلمان به <a href="liqui-moly">Liqui Moly</a> سر بزنید · <a href="contact">تماس</a> · <a href="products#supply">کاتالوگ تامین</a>', cta: { title: 'آماده استعلام کلاه، کاپشن یا بوت هستید؟', desc: 'سایز لباس یا کد SKU را بفرستید — پیش‌فاکتور + اعلام ارسال بعد از سفارش', btnForm: 'فرم استعلام', btnServices: 'کاتالوگ محصولات' }, sticky: { label: 'استعلام اتو‌موتو', hint: 'قیمت دلاری تحویل ایران' }, geoText: 'تامین تجهیزات موتورسیکلت — قیمت دلاری تحویل ایران.', related: [{ title: 'Liqui Moly', desc: 'روغن و افزودنی خودرو' }, { title: 'Teltonika', desc: 'ردیاب ناوگان' }, { title: 'کاتالوگ محصولات', desc: 'برندهای تامین B2B' }, { title: 'تماس و استعلام', desc: 'استعلام اتو‌موتو' }] }
    },
    tr: {
      ...
      autoMotoPage: { sections: {
        trust: { eyebrow: 'Neden Bizdavar?', title: 'Tam motosiklet ekipmanı kataloğu', desc: 'Kart fiyatı İran teslim USD’dir (liste TL ÷ 48 + %20). Fiyat yoksa yalnızca teklif.' },
        buy: { eyebrow: 'Satın alma yolu', title: 'Üründen teslimata — 5 adım', desc: 'Ürün teklifi ayrı, kargo ayrı — ikisi de proformada.' },
        quote: { eyebrow: 'Teklif rehberi', title: 'Beden veya SKU gönderin', desc: 'Giyim için beden, boy ve kilo — teklif hızlanır.' },
        highlights: { eyebrow: 'Çok sorulanlar', title: 'Kasktan touring bota', desc: 'İran teslim USD. Fiyat yoksa teklif.' },
        ...
        iran: { eyebrow: 'Kullanım', title: 'Kimler için?', desc: 'Motosiklet mağazası, şehir sürücüsü, off-road ve bireysel sipariş.', note: 'Beden yoksa boy ve kiloyu yazın.' },
        supply: { eyebrow: 'Bizdavar tedarik', title: 'Auto-Moto tedarik hizmeti', desc: 'Motosiklet ekipmanı için tek iletişim hattı.' },
        faq: { eyebrow: 'SSS', title: 'Fiyat, kargo ve beden', desc: 'Cevabı bulamadınız mı? WhatsApp yazın.' }
      }, officialNote: 'Kart fiyatı İran teslim USD’dir (liste TL ÷ 48 + %20). TL gösterilmez. Fiyat yoksa teklif. Alman motor yağı için <a href="liqui-moly">Liqui Moly</a> · <a href="contact">iletişim</a> · <a href="products#supply">tedarik kataloğu</a>', cta: { title: 'Kask, mont veya bot teklifine hazır mısınız?', desc: 'Beden veya SKU gönderin — proforma + kargo sonra', btnForm: 'Teklif formu', btnServices: 'Ürün kataloğu' }, sticky: { label: 'Auto-Moto teklifi', hint: 'İran teslim USD' }, geoText: 'Motosiklet ekipmanı tedariki — İran teslim USD.', related: [{ title: 'Liqui Moly', desc: 'Motor yağı ve katkı' }, { title: 'Teltonika', desc: 'Filo takip' }, { title: 'Ürün kataloğu', desc: 'B2B tedarik' }, { title: 'İletişim', desc: 'Auto-Moto teklifi' }] }
    },
    en: {
      ...
      autoMotoPage: { sections: {
        trust: { eyebrow: 'Why Bizdavar?', title: 'A full motorcycle gear catalog', desc: 'Card prices are Iran-delivery USD (listing TRY ÷ 48 + 20%). If there is no price, request a quote.' },
        buy: { eyebrow: 'Purchase path', title: 'From pick to dispatch — 5 steps', desc: 'Goods quote and postage are separate — both appear on the proforma.' },
        quote: { eyebrow: 'Quote guide', title: 'Send clothing size or SKU', desc: 'Size, height and weight for apparel — the proforma is faster.' },
        highlights: { eyebrow: 'High demand', title: 'From full-face helmets to touring boots', desc: 'Iran-delivery USD. If there is no price, inquiry only.' },
        ...
        iran: { eyebrow: 'Use cases', title: 'Who is it for?', desc: 'Motorcycle shops, city riders, off-road and personal orders.', note: 'Missing a size? Send height and weight.' },
        supply: { eyebrow: 'Supply by Bizdavar', title: 'Auto-Moto supply services', desc: 'One contact for motorcycle equipment.' },
        faq: { eyebrow: 'FAQ', title: 'Price, postage and sizing', desc: 'No answer? Message WhatsApp.' }
      }, officialNote: 'Card prices are Iran-delivery USD (listing TRY ÷ 48 + 20%). Lira is not shown. If there is no price, request a quote. For German engine oil see <a href="liqui-moly">Liqui Moly</a> · <a href="contact">contact</a> · <a href="products#supply">supply catalog</a>', cta: { title: 'Ready to quote a helmet, jacket or boots?', desc: 'Send clothing size or SKU — proforma plus postage after order', btnForm: 'Quote form', btnServices: 'Product catalog' }, sticky: { label: 'Auto-Moto quote', hint: 'Iran-delivery USD' }, geoText: 'Motorcycle gear supply — Iran-delivery USD.', related: [{ title: 'Liqui Moly', desc: 'Oils and additives' }, { title: 'Teltonika', desc: 'Fleet trackers' }, { title: 'Product catalog', desc: 'B2B supply' }, { title: 'Contact', desc: 'Auto-Moto quote' }] }
    }
  };
