    ...
    fa: {
      ...
      blogPage: {
        ...
        clusters: {
          ...
          industrialDesc: 'کد سفارش، پیش‌فاکتور و لجستیک از استانبول.'
        },
        faq: {
          ...
          items: [
            ...
            { q: 'برای استعلام VEGA بعد از مقاله چه کار کنم؟', a: 'مدل یا مشخصات مخزن را در واتساپ یا فرم تماس بفرستید — پیش‌فاکتور و کد سفارش از دفتر استانبول صادر می‌شود.' },
        ...
        geoText: 'مقالات تخصصی برای کسب‌وکارهای ایران و ترکیه — بازاریابی دیجیتال، سئو، طراحی وب چندزبانه و تامین تجهیزات صنعتی VEGA از استانبول.',
        related: [
    ...
    tr: {
      ...
      blogPage: {
        ...
        clusters: {
          ...
          industrialDesc: 'Sipariş kodu, proforma ve İstanbul lojistiği.'
        },
        faq: {
          eyebrow: 'SSS',
          title: 'Okumadan önce',
          ...
          items: [
            ...
            { q: 'VEGA teklifi için ne yapmalıyım?', a: 'Modeli veya tank verisini WhatsApp ya da iletişim formuna gönderin — proforma İstanbul ofisinden çıkar.' },
        ...
        geoText: 'İran ve Türkiye işletmeleri için yazılar — dijital pazarlama, SEO, çok dilli web ve İstanbul’dan VEGA endüstriyel tedariki.',
        related: [
    ...
    en: {
      ...
      blogPage: {
        ...
        clusters: {
          ...
          industrialDesc: 'Order code, proforma and logistics from Istanbul.'
        },
        faq: {
          eyebrow: 'FAQ',
          ...
          items: [
            ...
            { q: 'What should I do after reading a VEGA guide?', a: 'Send the model or tank data on WhatsApp or the contact form — the proforma and order code are issued from Istanbul.' },
        ...
        geoText: 'Specialized articles for businesses in Iran and Turkey — digital marketing, SEO, multilingual web design and VEGA industrial supply from Istanbul.',
        related: [
