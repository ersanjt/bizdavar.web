...
(function () {
  ...
  const page = {
    ...
    en: {
      ...
      }, officialNote: 'Technical information is based on the <a href="https://www.gamak.com/" target="_blank" rel="noopener noreferrer">official Gamak website</a>. For quotes — <a href="contact">contact Bizdavar</a> · <a href="vega">VEGA</a> · <a href="prosense">Prosense</a>', cta: { title: 'Ready for a Gamak quote?', desc: 'Send kW, rpm and application type — IE2/IE3/IE4 · Ex-proof · MV', btnForm: 'Quote form', btnServices: 'Industrial services' }, sticky: { label: 'Gamak quote' }, geoText: 'Gamak supply from Turkey to Iran — Persian technical consulting, proforma and logistics by Bizdavar Group.', related: [{ title: 'VEGA products', desc: 'Level and pressure sensors' }, { title: 'Prosense products', desc: 'Gas and flame detectors' }, { title: 'Industrial services', desc: 'B2B supply consulting' }, { title: 'Contact', desc: 'Free consultation' }] },
      digiSystemPage: { sections: {
  ...
  const caseStudy = {
    fa: {
      ...
      bizswap: {
        ...
        capabilities: {
          ...
          items: [
            { icon: '🔗', title: 'Connect Wallet', desc: 'اتصال Trust Wallet و کیف پول‌های سازگار با Web3 — نمایش موجودی From/To.' },
            { icon: '💱', title: 'DEX Swap', desc: 'تبدیل USDT (یا stablecoin) به توکن پروژه با نرخ لحظه‌ای و تأیید در کیف پول.' },
            { icon: '🎯', title: 'Presale', desc: 'خرید در مرحله پیش‌فروش — مستقیم از landing page پروژه.' },
            { icon: '📊', title: 'Slippage & Min. Received', desc: 'نمایش اسلیپیج (مثلاً ۰.۵٪) و حداقل توکن دریافتی قبل از تأیید.' },
            { icon: '🪙', title: 'Token Selector', desc: 'انتخاب توکن مبدأ و مقصد از لیست پشتیبانی‌شده.' },
            { icon: '⏳', title: 'Transaction Status', desc: 'پیام «Processing…» هنگام ارسال تراکنش و بازخورد موفقیت/خطا.' }
          ]
        },
        flow: {
          eyebrow: 'جریان کار',
          ...
          steps: [
            { title: 'اتصال کیف پول', desc: 'کاربر Connect Wallet را می‌زند و شبکه BEP-20 را تأیید می‌کند.' },
        ...
        admin: {
          ...
          items: [
            'Change Rate — به‌روزرسانی نرخ swap در قرارداد (onlyOwner)',
            'Claim Tokens — برداشت توکن‌های لیست‌شده از قرارداد (onlyOwner)',
            'همگام‌سازی نرخ on-site با Admin Panel',
      ...
      fxguard: {
        hero: {
          tag: 'محصول SaaS · WhatsApp CRM',
          title: 'FXGuard — CRM واتساپ برای کل تیم',
          desc: 'یک شماره. یک پنل. هر مکالمه ثبت می‌شود، هر مشتری به‌خاطر سپرده می‌شود — پیام انبوه و پاسخ خودکار بدون IT.',
          regions: '🇹🇷 ترکیه · 🇦🇪 دبی · 🇪🇺 اروپا · 🇮🇷 ایران',
          trust: '۲۰۰+ کسب‌وکار در ۴ منطقه · ★★★★★ ۴.۹/۵',
          ctaPricing: 'مشاهده پلن‌ها',
          ctaDemo: 'دمو رایگان در واتساپ',
          ctaSite: 'fxguard.io',
          ctaPanel: 'ورود به پنل'
        },
        stats: {
          businesses: 'کسب‌وکار فعال',
          regions: 'منطقه',
          regionsVal: 'TR · AE · EU · IR',
          uptime: 'آپ‌تایم',
          setup: 'میانگین راه‌اندازی'
        },
        problem: {
          eyebrow: 'مشکل',
          title: 'آشناست؟',
          desc: 'هر کسب‌وکار در حال رشد به همین دیوارها می‌خورد — fxguard برای حل آن‌ها ساخته شده.',
          items: [
        ...
        steps: {
          ...
          desc: 'بدون تنظیمات فنی. بدون تیم IT. فقط وصل کنید و شروع کنید.',
          items: [
            { num: '01', icon: '🔗', title: 'شماره را وصل کنید', desc: 'شماره WhatsApp Business موجود را در کمتر از ۵ دقیقه به پنل وصل کنید. شماره همیشه مال شماست.' },
          ...
          cta: 'شروع کنید — میانگین راه‌اندازی: ۱۰ دقیقه'
        },
        features: {
          eyebrow: 'امکانات',
          title: 'هر آنچه تیم شما نیاز دارد',
          desc: 'نه فقط چت — CRM کامل ساخته‌شده دور واتساپ.',
          items: [
        ...
        pricing: {
          ...
          desc: 'بدون هزینه به ازای هر اپراتور. یک قیمت ثابت، تیم نامحدود.',
          note: 'همه پلن‌ها شامل دمو زنده رایگان هستند. برای شروع کارت اعتباری لازم نیست.',
          plans: [
            { id: 'monthly', name: 'ماهانه', price: '$49', period: '/ماه', desc: 'دسترسی کامل، لغو هر زمان.', features: ['۱ شماره واتساپ', 'کارکنان نامحدود', 'پیام انبوه', 'پاسخ خودکار', 'اینباکس تیمی', '۴ زبان UI'], cta: 'شروع کنید', href: 'https://fxguard.io' },
            { id: 'yearly', name: 'سالانه', price: '$490', period: '/سال', badge: 'محبوب‌ترین — ۲ ماه رایگان', desc: 'معادل $40.83/ماه — بهترین ارزش.', features: ['همه امکانات ماهانه', 'پشتیبانی اولویت‌دار', 'جلسه onboarding', 'دسترسی API', 'آنالیتیکس پیشرفته'], cta: 'پلن سالانه', href: 'https://fxguard.io', featured: true },
            { id: 'enterprise', name: 'Enterprise', price: 'سفارشی', period: '', desc: 'چند شماره، تیم بزرگ یا آژانس.', features: ['چند شماره واتساپ', 'مدیر اختصاصی', 'یکپارچه‌سازی سفارشی', 'White-label', 'SLA'], cta: 'تماس بگیرید', href: 'https://fxguard.io#contact' }
          ]
        },
        faq: {
          eyebrow: 'سوالات',
          ...
          items: [
            { q: 'هزینه WhatsApp CRM چقدر است؟', a: 'از $49/ماه با تیم نامحدود — بدون هزینه به ازای هر مکالمه یا اپراتور.' },
            { q: 'چند نفر می‌توانند از یک شماره استفاده کنند؟', a: 'نامحدود — همه از یک پنل و یک شماره WhatsApp Business کار می‌کنند.' },
            { q: 'پیام انبوه پشتیبانی می‌شود؟', a: 'بله — با شخصی‌سازی، تأخیر هوشمند و زمان‌بندی کمپین.' },
            { q: 'دمو رایگان دارد؟', a: 'بله — دمو زنده در واتساپ بدون نیاز به کارت اعتباری.' },
            { q: 'از فارسی پشتیبانی می‌کند؟', a: 'بله — UI و پشتیبانی به فارسی، ترکی، عربی و انگلیسی.' }
          ]
        },
        about: {
          title: 'ساخته‌شده توسط بیزدوار',
          body: '<strong>FXGuard</strong> محصول SaaS توسعه‌یافته توسط <strong>تیم بیزدوار</strong> است — CRM واتساپ، پنل تیمی، وب‌اپ و زیرساخت API با کدنویسی اختصاصی. بیزدوار طراحی، توسعه و نگهداری پلتفرم را انجام می‌دهد.',
          ctaSite: 'وبسایت FXGuard',
          ctaPanel: 'app.fxguard.io',
          ctaContact: 'تماس با بیزدوار'
        },
        cta: {
          title: 'مشتریان منتظرند',
          desc: 'دیگر لیدها را با پاسخ دیر از دست ندهید — در ۱۰ دقیقه شروع کنید، دمو رایگان.',
          btnStart: 'شروع — از $49/ماه',
          btnDemo: 'دمو رایگان در واتساپ'
        },
        related: { title: 'محصولات و خدمات مرتبط' },
        geoText: 'CRM واتساپ برای بازارهای ترکیه، امارات، اروپا و ایران — توسعه‌یافته توسط بیزدوار گروپ.'
      },
    ...
    tr: {
      ...
      fxguard: {
        hero: { tag: 'SaaS ürün · WhatsApp CRM', title: 'FXGuard — Tüm ekip için WhatsApp CRM', desc: 'Tek numara. Tek panel. Her konuşma kayıtlı — toplu mesaj ve 7/24 otomatik yanıt, IT ekibi gerekmez.', regions: '🇹🇷 Türkiye · 🇦🇪 Dubai · 🇪🇺 Avrupa · 🇮🇷 İran', trust: '200+ işletme · ★★★★★ 4.9/5', ctaPricing: 'Planları gör', ctaDemo: 'WhatsApp\'ta ücretsiz demo', ctaSite: 'fxguard.io', ctaPanel: 'Panele giriş' },
        stats: { businesses: 'Aktif işletme', regions: 'Bölge', regionsVal: 'TR · AE · EU · IR', uptime: 'Uptime', setup: 'Ort. kurulum' },
        problem: { eyebrow: 'Sorun', title: 'Tanıdık mı?', desc: 'Büyüyen her işletme bu duvarlarla karşılaşır — fxguard bunları çözmek için yapıldı.', items: [{ icon: '📱', title: 'Birden fazla telefon, sıfır kontrol', desc: 'Üç personel, üç telefon. Kim ne cevapladı bilinmiyor — müşteri yanıtsız kalıyor veya çift cevap alıyor.' }, { icon: '⏰', title: 'Gece 2\'de cevap', desc: 'Otomatik yanıt yoksa biri her zaman nöbette. Müşteriler anında cevap bekliyor.' }, { icon: '📋', title: 'Toplu mesaj yorucu', desc: '200 kişiye tek tek kopyala-yapıştır. Saatler sürer, hata çok.' }] },
        steps: { eyebrow: 'Nasıl çalışır', title: '3 adımda hazır', desc: 'Teknik kurulum yok. Sadece bağlanın ve başlayın.', items: [{ num: '01', icon: '🔗', title: 'Numaranızı bağlayın', desc: 'Mevcut WhatsApp Business numaranızı 5 dakikadan kısa sürede panele bağlayın.' }, { num: '02', icon: '👥', title: 'Ekibinizi ekleyin', desc: 'Personeli davet edin, roller atayın. Herkes aynı panelden yanıtlar.' }, { num: '03', icon: '🚀', title: 'Büyüyün ve otomatikleştirin', desc: 'Otomatik yanıt, toplu kampanyalar, her konuşmayı takip edin.' }], cta: 'Hemen başlayın — ortalama kurulum: 10 dk' },
        features: { eyebrow: 'Özellikler', title: 'Ekibinizin ihtiyacı olan her şey', desc: 'Sadece sohbet değil — WhatsApp etrafında tam CRM.', items: [{ icon: '📥', title: 'Birleşik ekip gelen kutusu', desc: 'Tüm konuşmalar tek yerde. Atama, not, durum.' }, { icon: '📤', title: 'Toplu mesaj', desc: 'Binlerce kişiye kişiselleştirilmiş mesaj, akıllı gecikme.' }, { icon: '🤖', title: '7/24 otomatik yanıt', desc: 'Mesai dışı, anahtar kelime, karşılama kuralları.' }, { icon: '📊', title: 'Analitik ve raporlar', desc: 'Yanıt süresi, hacim, ekip performansı.' }, { icon: '👥', title: 'Rol tabanlı erişim', desc: 'Yönetici, operatör, gözlemci — doğru yetkiler.' }, { icon: '🔌', title: 'API entegrasyonu', desc: 'Mevcut CRM veya e-ticaret sisteminize REST API ile bağlanın.' }] },
        audiences: { eyebrow: 'Kimler için', title: 'Sizin gibi işletmeler için', desc: 'İstanbul restoranlarından Dubai kliniklerine — WhatsApp\'ta müşteriyle konuşan her ekip.', items: [{ icon: '🏥', title: 'Klinik ve sağlık', region: 'Türkiye · BAE · Avrupa', desc: 'Randevu, hatırlatma, takip — tek panelden.', tag: 'Randevu otomasyonu' }, { icon: '🛍️', title: 'E-ticaret', region: 'Tüm bölgeler', desc: 'Sipariş güncellemeleri, sepet kurtarma, 500+ günlük mesaj.', tag: 'Toplu kampanya' }, { icon: '🏠', title: 'Emlak', region: 'Dubai · İstanbul', desc: 'İlan paylaşımı, görüntüleme, lead takibi.', tag: 'Lead takibi' }, { icon: '🍽️', title: 'Restoran', region: 'Türkiye · Avrupa', desc: 'Rezervasyon, paket servis, günlük menü.', tag: 'Otomatik rezervasyon' }] },
        pricing: { eyebrow: 'Fiyat', title: 'Basit ve şeffaf fiyatlandırma', desc: 'Kullanıcı başına ücret yok. Sabit fiyat, sınırsız ekip.', note: 'Tüm planlarda ücretsiz canlı demo. Başlamak için kredi kartı gerekmez.', plans: [{ id: 'monthly', name: 'Aylık', price: '$49', period: '/ay', desc: 'Tam erişim, istediğiniz zaman iptal.', features: ['1 WhatsApp numarası', 'Sınırsız personel', 'Toplu mesaj', 'Otomatik yanıt', 'Ekip gelen kutusu', '4 dil UI'], cta: 'Başlayın', href: 'https://fxguard.io' }, { id: 'yearly', name: 'Yıllık', price: '$490', period: '/yıl', badge: 'En popüler — 2 ay bedava', desc: 'Aylık $40.83 eşdeğeri.', features: ['Aylık plandaki her şey', 'Öncelikli destek', 'Onboarding oturumu', 'API erişimi', 'Gelişmiş analitik'], cta: 'Yıllık plan', href: 'https://fxguard.io', featured: true }, { id: 'enterprise', name: 'Enterprise', price: 'Özel', period: '', desc: 'Çoklu numara veya büyük ekipler.', features: ['Birden fazla numara', 'Özel hesap yöneticisi', 'Özel entegrasyonlar', 'White-label', 'SLA'], cta: 'Konuşalım', href: 'https://fxguard.io#contact' }] },
        faq: { eyebrow: 'SSS', title: 'Sık sorulan sorular', items: [{ q: 'WhatsApp CRM ne kadar?', a: '$49/ay\'dan — sınırsız ekip, konuşma başına ücret yok.' }, { q: 'Birden fazla personel aynı numarayı kullanabilir mi?', a: 'Evet — sınırsız personel, tek panel ve tek numara.' }, { q: 'Toplu mesaj var mı?', a: 'Evet — kişiselleştirme, gecikme ve zamanlama ile.' }, { q: 'Ücretsiz demo var mı?', a: 'Evet — WhatsApp üzerinden canlı demo, kredi kartı gerekmez.' }, { q: 'Türkçe destek var mı?', a: 'Evet — TR, AR, FA ve EN UI ve destek.' }] },
        about: { title: 'Bizdavar tarafından geliştirildi', body: '<strong>FXGuard</strong>, <strong>Bizdavar ekibi</strong> tarafından geliştirilen SaaS ürünüdür — WhatsApp CRM, ekip paneli, web uygulaması ve özel API altyapısı.', ctaSite: 'FXGuard web sitesi', ctaPanel: 'app.fxguard.io', ctaContact: 'Bizdavar ile iletişim' },
        cta: { title: 'Müşterileriniz bekliyor', desc: 'Yavaş yanıtlarla lead kaybetmeyin — 10 dakikada başlayın.', btnStart: 'Başlayın — $49/ay\'dan', btnDemo: 'WhatsApp\'ta ücretsiz demo' },
        related: { title: 'İlgili ürün ve hizmetler' },
        geoText: 'Türkiye, BAE, Avrupa ve İran için WhatsApp CRM — Bizdavar Group tarafından geliştirildi.'
      },
      bzDiamond: {
    ...
    en: {
      ...
      fxguard: {
        hero: { tag: 'SaaS product · WhatsApp CRM', title: 'FXGuard — WhatsApp CRM for your whole team', desc: 'One number. One panel. Every conversation tracked — bulk messaging and 24/7 auto-reply without an IT team.', regions: '🇹🇷 Turkey · 🇦🇪 Dubai · 🇪🇺 Europe · 🇮🇷 Iran', trust: '200+ businesses · ★★★★★ 4.9/5', ctaPricing: 'See plans', ctaDemo: 'Free demo on WhatsApp', ctaSite: 'fxguard.io', ctaPanel: 'Open panel' },
        stats: { businesses: 'Active businesses', regions: 'Regions', regionsVal: 'TR · AE · EU · IR', uptime: 'Uptime', setup: 'Avg. setup' },
        problem: { eyebrow: 'The problem', title: 'Sound familiar?', desc: 'Every growing business hits these walls — fxguard was built to solve them.', items: [{ icon: '📱', title: 'Multiple phones, zero control', desc: 'Three staff, three phones. Nobody knows who replied — customers get ignored or double-answered.' }, { icon: '⏰', title: 'Replying at 2am', desc: 'Without auto-replies someone is always on call. Customers expect instant replies.' }, { icon: '📋', title: 'Bulk messaging is exhausting', desc: 'Copy-pasting to 200 contacts one by one. Hours per campaign. Errors everywhere.' }] },
        steps: { eyebrow: 'How it works', title: 'Up & running in 3 steps', desc: 'No technical setup. No IT team. Just connect and go.', items: [{ num: '01', icon: '🔗', title: 'Connect your number', desc: 'Link your existing WhatsApp Business number in under 5 minutes. Your number stays yours.' }, { num: '02', icon: '👥', title: 'Add your team', desc: 'Invite staff, assign roles. Everyone replies from the same dashboard.' }, { num: '03', icon: '🚀', title: 'Grow & automate', desc: 'Auto-replies, bulk campaigns, track every conversation.' }], cta: 'Start now — average setup: 10 minutes' },
        features: { eyebrow: 'Features', title: 'Everything your team needs', desc: 'Not just chat — a full CRM built around WhatsApp.', items: [{ icon: '📥', title: 'Unified team inbox', desc: 'All conversations in one place. Assign chats, notes, status.' }, { icon: '📤', title: 'Bulk messaging', desc: 'Personalized messages to thousands with smart delays and scheduling.' }, { icon: '🤖', title: 'Auto-response 24/7', desc: 'After-hours rules, keywords, greetings — never leave a customer waiting.' }, { icon: '📊', title: 'Analytics & reports', desc: 'Response times, volume, team performance in one dashboard.' }, { icon: '👥', title: 'Role-based access', desc: 'Manager, agent, viewer — everyone sees what they need.' }, { icon: '🔌', title: 'API integration', desc: 'Connect to your CRM, e-commerce or booking system via REST API.' }] },
        audiences: { eyebrow: 'Who it\'s for', title: 'Built for businesses like yours', desc: 'From Istanbul restaurants to Dubai clinics — any team that talks to customers on WhatsApp.', items: [{ icon: '🏥', title: 'Clinics & healthcare', region: 'Turkey · UAE · Europe', desc: 'Appointments, reminders, follow-ups — one panel.', tag: 'Booking automation' }, { icon: '🛍️', title: 'E-commerce', region: 'All regions', desc: 'Order updates, cart recovery, 500+ daily chats with a 3-person team.', tag: 'Bulk campaigns' }, { icon: '🏠', title: 'Real estate', region: 'Dubai · Istanbul', desc: 'Listings, viewings, lead follow-up with full history.', tag: 'Lead tracking' }, { icon: '🍽️', title: 'Restaurants', region: 'Turkey · Europe', desc: 'Reservations, catering, daily specials — automate routine messages.', tag: 'Auto-reservation' }] },
        pricing: { eyebrow: 'Pricing', title: 'Simple, honest pricing', desc: 'No per-agent fees. One flat price, unlimited team.', note: 'All plans include a free live demo. No credit card required to start.', plans: [{ id: 'monthly', name: 'Monthly', price: '$49', period: '/mo', desc: 'Full access, cancel anytime.', features: ['1 WhatsApp number', 'Unlimited staff', 'Bulk messaging', 'Auto-response', 'Team inbox', '4-language UI'], cta: 'Get started', href: 'https://fxguard.io' }, { id: 'yearly', name: 'Yearly', price: '$490', period: '/yr', badge: 'Most popular — 2 months free', desc: 'Best value — $40.83/month equivalent.', features: ['Everything in Monthly', 'Priority support', 'Live onboarding', 'API access', 'Advanced analytics'], cta: 'Get yearly plan', href: 'https://fxguard.io', featured: true }, { id: 'enterprise', name: 'Enterprise', price: 'Custom', period: '', desc: 'Multiple numbers or large teams.', features: ['Multiple WhatsApp numbers', 'Dedicated account manager', 'Custom integrations', 'White-label', 'SLA'], cta: 'Let\'s talk', href: 'https://fxguard.io#contact' }] },
        faq: { eyebrow: 'FAQ', title: 'Common questions', items: [{ q: 'How much does WhatsApp CRM cost?', a: 'From $49/month with unlimited team — no per-conversation billing.' }, { q: 'Can multiple staff use one number?', a: 'Yes — unlimited staff on one panel and one WhatsApp Business number.' }, { q: 'Does it support bulk messaging?', a: 'Yes — with personalization, smart delays and campaign scheduling.' }, { q: 'Is there a free demo?', a: 'Yes — live demo on WhatsApp, no credit card required.' }, { q: 'Does it support Farsi and Turkish?', a: 'Yes — EN, AR, TR and FA UI and support.' }] },
        about: { title: 'Built by Bizdavar', body: '<strong>FXGuard</strong> is a SaaS product developed by the <strong>Bizdavar team</strong> — WhatsApp CRM, team panel, web app and custom API infrastructure.', ctaSite: 'FXGuard website', ctaPanel: 'app.fxguard.io', ctaContact: 'Contact Bizdavar' },
        cta: { title: 'Your customers are waiting', desc: 'Stop losing leads to slow replies — start in 10 minutes with a free demo.', btnStart: 'Get started — from $49/month', btnDemo: 'Free demo on WhatsApp' },
        related: { title: 'Related products & services' },
        geoText: 'WhatsApp CRM for Turkey, UAE, Europe and Iran — built by Bizdavar Group.'
      },
      bzDiamond: {
