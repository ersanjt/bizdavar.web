...
(function () {
  ...
  const page = {
    fa: {
      ...
      autoMotoPage: { sections: {
        trust: { eyebrow: 'چرا از بیزدوار بخرید؟', title: 'کاتالوگ کامل تجهیزات موتورسیکلت', desc: 'قیمت روی کارت به دلار است و برای تحویل در ایران. اگر قیمت نباشد، فقط استعلام می‌کنیم.' },
        buy: { eyebrow: 'مسیر خرید', title: 'از انتخاب محصول تا ارسال — پنج مرحله', desc: 'مبلغ کالا جدا، هزینه پست جدا — هر دو قبل از پرداخت در پیش‌فاکتور می‌آید.' },
        quote: { eyebrow: 'راهنمای استعلام', title: 'سایز لباس یا کد کالا را بفرستید', desc: 'برای لباس، سایز و قد و وزن کافی است — پیش‌فاکتور زودتر آماده می‌شود.' },
        highlights: { eyebrow: 'محصولات پرتقاضا', title: 'از کلاه ایمنی تا بوت تورینگ', desc: 'قیمت روی کارت به دلار و برای تحویل در ایران است. اگر قیمت نباشد استعلام کنید.' },
        catalog: { eyebrow: 'کاتالوگ کامل', title: 'تجهیزات موتورسیکلت', desc: '۳۸۷۶ محصول موتورسیکلت با عکس واقعی: کلاه، کاپشن، دستکش، شلوار، بوت و اینترکام.' },
        iran: { eyebrow: 'کاربرد', title: 'برای چه کسانی است؟', desc: 'فروشگاه موتور، موتورسوار شهری، آفرود و سفارش شخصی.', note: 'سایز ندارید؟ قد و وزن را در واتساپ بفرستید.' },
        supply: { eyebrow: 'تامین از بیزدوار', title: 'خدمات تامین فروشگاه موتور', desc: 'یک نقطه تماس فارسی برای کلاه، کاپشن، بوت و بقیه تجهیزات موتور.' },
        faq: { eyebrow: 'سوالات متداول', title: 'قیمت، پست و سایز', desc: 'پاسخ را پیدا نکردید؟ در واتساپ پیام بدهید.' }
      }, officialNote: 'قیمت روی کارت به دلار است و برای تحویل در ایران. اگر قیمت نباشد فقط استعلام است. روغن موتور آلمان را در <a href="liqui-moly">Liqui Moly</a> ببینید · <a href="auto-moto">اتوموتو</a> · <a href="car-parts">فروشگاه ترمز</a> · <a href="contact">تماس</a>', cta: { title: 'برای کلاه، کاپشن یا بوت استعلام می‌خواهید؟', desc: 'سایز لباس یا کد کالا را بفرستید. پیش‌فاکتور می‌آید؛ هزینه ارسال بعد از سفارش اعلام می‌شود.', btnForm: 'فرم استعلام', btnServices: 'کاتالوگ محصولات' }, sticky: { label: 'استعلام تجهیزات موتور', hint: 'قیمت دلاری، تحویل ایران' }, geoText: 'تامین تجهیزات موتورسیکلت — قیمت روی کارت به دلار و برای تحویل در ایران.', related: [{ title: 'اتوموتو', desc: 'دو فروشگاه جدا: موتور و ترمز' }, { title: 'فروشگاه ترمز', desc: 'لنت و دیسک با برند و مدل' }, { title: 'Liqui Moly', desc: 'روغن و افزودنی خودرو' }, { title: 'تماس و استعلام', desc: 'سایز لباس یا کد کالا' }] }
    },
    tr: {
      aboutPage: { hero: { tag: 'Bizdavar Hakkında', title: 'Bizdavar üç ayrı iş yapar', desc: 'Dijital hizmetler, kendi ürünlerimiz veya endüstriyel tedarik — 2013’ten beri.' }, whatIs: { title: 'Bizdavar Group nedir?', p1: 'Bizdavar Group <strong>2013</strong>’ten beri çalışır — kurucu: <strong>Ersan Jahed Tabrizi</strong>. Üç ayrı iş: <a href="services">dijital hizmetler</a>, <a href="products">kendi ürünlerimiz</a> (BizPet, FXGuard), ve <a href="products#supply">endüstriyel tedarik</a> (VEGA, Prosense, Liqui Moly).', p2: '11 ülkede 100+ proje. Şirket kaydı Erivan; İran tüzel kişiliği Tebriz. İşler <a href="portfolio">portfolyoda</a>.' }, features: ['Dijital pazarlama', 'Profesyonel web tasarım', 'Ekipman tedariki', 'Altyapı yönetimi'], stats: [{ value: '+13', label: 'Yıl deneyim' }, { value: '+100', label: 'Proje' }, { value: '11', label: 'Ülke' }, { value: '3', label: 'İş yolu' }], navAria: 'Sayfa bölümleri', nav: [{ href: '#profile', label: 'Kimlik' }, { href: '#activities', label: 'Uzmanlık' }, { href: '#ecosystem', label: 'Ekosistem' }, { href: '#presence', label: 'Küresel varlık' }, { href: '#highlights', label: 'Başarılar' }, { href: '#sources', label: 'Kaynaklar' }, { href: '#trust', label: 'Güven' }, { href: '#faq', label: 'SSS' }], sections: { identityEyebrow: 'Kurumsal kimlik', identityTitle: 'Bizdavar Group’a kısa bakış', leadershipEyebrow: 'Liderlik', leadershipTitle: 'Kurucu ve ekip', activitiesEyebrow: 'Üç iş yolu', activitiesTitle: 'Hangi işimizle geldiniz?', ecosystemEyebrow: 'Ekosistem', ecosystemTitle: 'İlgili marka ve projeler', ecosystemDesc: 'Bizdavar’ın geliştirdiği veya yönettiği dijital ve endüstriyel ekosistemden örnekler', presenceEyebrow: 'Küresel varlık', presenceTitle: 'Aktif ülkeler', presenceDesc: 'Uluslararası proje ağı — ofisler: İran, Türkiye, Ermenistan ve Dubai', exhibitionsEyebrow: 'Fuar ve etkinlik', exhibitionsTitle: 'Teknoloji fuarlarındaki varlık', exhibitionsDesc: 'RINOTEX Tabriz’ten üniversite fuarlarına — inovasyon ve ticarileştirme etkinlikleri', achievementsEyebrow: 'Başarılar', achievementsTitle: 'Bizdavar ürün ve inovasyonları', achievementsDesc: 'Geçmişte ürettiğimiz donanım şirket tarihinde — bugünün önceliği tedarik, web ve yazılım.', sourcesEyebrow: 'Doğrulanmış kaynaklar', sourcesTitle: 'Medya, fuarlar ve doğrulanabilir referanslar', sourcesDesc: 'Ürünler, fuarlar ve Bizdavar geçmişi hakkında yayımlanan resmi bağlantılar — site içi iddialardan bağımsız.', credentialsEyebrow: 'Sertifikalar', credentialsTitle: 'Doğrulanmış yetkinlikler', proofEyebrow: 'Profesyonel güven', proofTitle: 'Güven göstergeleri', proofDesc: 'Doğrulanabilir kamu kaynaklarına dayalıdır — sahte yorum yoktur', faqEyebrow: 'SSS', faqTitle: 'Bizdavar hakkında sık sorulanlar' }, relatedLinks: [{ title: 'Hizmetlerimiz', url: 'services', desc: 'Dijital pazarlama, web, SMM ve endüstri' }, { title: 'Portfolyo', url: 'portfolio', desc: 'Web tasarım, ürünler ve endüstriyel tedarik' }, { title: 'İletişim', url: 'contact', desc: 'Ücretsiz danışmanlık' }], values: { title: 'Değerlerimiz', items: [{ title: 'Sonuç odaklılık', desc: 'Sadece uygulama değil, satış, dönüşüm ve marka büyümesi.' }, { title: 'Şeffaf iş birliği', desc: 'Düzenli raporlama ve ekiple doğrudan iletişim.' }, { title: 'Küresel pazar', desc: 'İran, Türkiye ve uluslararası pazarlarda projeler.' }, { title: 'Hızlı uygulama', desc: 'Fast Web Studio — 5 günde web sitesi teslimi.' }] }, cta: { title: 'Bizdavar ile çalışmaya hazır mısınız?', desc: 'İlk danışmanlık ücretsiz — <a href="contact" class="link-yellow">iletişim formu</a> veya WhatsApp üzerinden.', btn: 'Bize ulaşın' } },
      ...
      autoMotoPage: { sections: {
        trust: { eyebrow: 'Neden Bizdavar?', title: 'Tam motosiklet ekipmanı kataloğu', desc: 'Karttaki fiyat ABD dolarıdır ve İran teslimi içindir. Fiyat yoksa yalnızca teklif alınır.' },
        buy: { eyebrow: 'Satın alma yolu', title: 'Üründen sevkiyata — beş adım', desc: 'Ürün tutarı ayrı, kargo ayrı. İkisi de ödemeden önce proformada yazar.' },
        quote: { eyebrow: 'Teklif rehberi', title: 'Bedeninizi veya ürün kodunu gönderin', desc: 'Giyimde beden, boy ve kilo yeter — proforma daha çabuk çıkar.' },
        highlights: { eyebrow: 'Çok sorulanlar', title: 'Kasktan touring bota', desc: 'Karttaki fiyat ABD doları, İran teslimi. Fiyat yoksa teklif alın.' },
        catalog: { eyebrow: 'Tam katalog', title: 'Motosiklet ekipmanı', desc: '3876 motosiklet ürünü, gerçek fotoğrafla: kask, mont, eldiven, pantolon, bot ve interkom.' },
        iran: { eyebrow: 'Kullanım', title: 'Kimler için?', desc: 'Motosiklet dükkânı, şehir sürücüsü, off-road ve bireysel sipariş.', note: 'Bedeniniz yoksa boy ve kiloyu yazın.' },
        supply: { eyebrow: 'Bizdavar tedariki', title: 'Motosiklet tedarik hizmeti', desc: 'Kask, mont, bot ve diğer ekipman için tek iletişim hattı.' },
        faq: { eyebrow: 'SSS', title: 'Fiyat, kargo ve beden', desc: 'Cevabı bulamadınız mı? WhatsApp’tan yazın.' }
      }, officialNote: 'Karttaki fiyat ABD dolarıdır ve İran teslimi içindir. Fiyat yoksa yalnızca teklif. Alman motor yağı için <a href="liqui-moly">Liqui Moly</a> · <a href="auto-moto">Auto-Moto</a> · <a href="car-parts">fren mağazası</a> · <a href="contact">iletişim</a>', cta: { title: 'Kask, mont veya bot için teklif ister misiniz?', desc: 'Beden veya SKU gönderin. Proforma gelir; kargo siparişten sonra netleşir.', btnForm: 'Teklif formu', btnServices: 'Ürün kataloğu' }, sticky: { label: 'Motosiklet teklifi', hint: 'ABD doları, İran teslimi' }, geoText: 'Motosiklet ekipmanı tedariki — karttaki fiyat ABD doları, İran teslimi.', related: [{ title: 'Auto-Moto', desc: 'İki ayrı mağaza: motosiklet ve fren' }, { title: 'Fren mağazası', desc: 'Balata ve disk, marka ve modele göre' }, { title: 'Liqui Moly', desc: 'Motor yağı ve katkı' }, { title: 'İletişim', desc: 'Beden veya ürün kodu' }] }
    },
    en: {
      aboutPage: { hero: { tag: 'About Bizdavar', title: 'Bizdavar does three separate things', desc: 'Digital services, products we build, or industrial supply — since 2013.' }, whatIs: { title: 'What is Bizdavar Group?', p1: 'Bizdavar Group has worked since <strong>2013</strong> — founder: <strong>Ersan Jahed Tabrizi</strong>. Three separate lines: <a href="services">digital services</a>, <a href="products">products we build</a> (BizPet, FXGuard), and <a href="products#supply">industrial supply</a> (VEGA, Prosense, Liqui Moly).', p2: '100+ projects in 11 countries. Company registration in Yerevan; Iran legal entity in Tabriz. See the <a href="portfolio">portfolio</a>.' }, features: ['Digital marketing', 'Professional web design', 'Equipment supply', 'Infrastructure management'], stats: [{ value: '+13', label: 'Years experience' }, { value: '+100', label: 'Projects' }, { value: '11', label: 'Countries' }, { value: '3', label: 'Work paths' }], navAria: 'Page sections', nav: [{ href: '#profile', label: 'Profile' }, { href: '#activities', label: 'Expertise' }, { href: '#ecosystem', label: 'Ecosystem' }, { href: '#presence', label: 'Global presence' }, { href: '#highlights', label: 'Highlights' }, { href: '#sources', label: 'Sources' }, { href: '#trust', label: 'Trust' }, { href: '#faq', label: 'FAQ' }], sections: { identityEyebrow: 'Company profile', identityTitle: 'Bizdavar Group at a glance', leadershipEyebrow: 'Leadership', leadershipTitle: 'Founder and team', activitiesEyebrow: 'Three work paths', activitiesTitle: 'Which of our lines are you here for?', ecosystemEyebrow: 'Ecosystem', ecosystemTitle: 'Related brands and projects', ecosystemDesc: 'Examples from the digital and industrial ecosystem Bizdavar has developed or managed', presenceEyebrow: 'Global presence', presenceTitle: 'Active countries', presenceDesc: 'International project network offices in Iran, Turkey, Armenia and Dubai — projects across Europe and the US', exhibitionsEyebrow: 'Exhibitions & events', exhibitionsTitle: 'Technology exhibition presence', exhibitionsDesc: 'Innovation and commercialization events — from RINOTEX Tabriz to university fairs', achievementsEyebrow: 'Achievements', achievementsTitle: 'Bizdavar products & innovation', achievementsDesc: 'Hardware we built in the past lives in company history — today the priority is supply, websites and software.', sourcesEyebrow: 'Verified sources', sourcesTitle: 'Media, exhibitions and verifiable references', sourcesDesc: 'Official links published about products, exhibitions and Bizdavar history — independent of on-site claims.', credentialsEyebrow: 'Certifications', credentialsTitle: 'Verified skills', proofEyebrow: 'Professional credibility', proofTitle: 'Trust indicators', proofDesc: 'Based on verifiable public sources — no fabricated testimonials', faqEyebrow: 'FAQ', faqTitle: 'Common questions about Bizdavar' }, relatedLinks: [{ title: 'Our services', url: 'services', desc: 'Digital marketing, web, SMM and industry' }, { title: 'Portfolio', url: 'portfolio', desc: 'Web design, products and industrial supply' }, { title: 'Contact us', url: 'contact', desc: 'Free consultation' }], values: { title: 'Our values', items: [{ title: 'Outcome focus', desc: 'Sales, conversion and brand growth — not just execution.' }, { title: 'Transparent collaboration', desc: 'Regular reporting and direct communication with the team.' }, { title: 'Global market', desc: 'Projects in Iran, Turkey and international markets.' }, { title: 'Fast execution', desc: 'Fast Web Studio — website delivery in 5 days.' }] }, cta: { title: 'Ready to work with Bizdavar?', desc: 'Initial consultation is free — through the <a href="contact" class="link-yellow">contact form</a> or WhatsApp.', btn: 'Contact us' } },
      ...
      autoMotoPage: { sections: {
        trust: { eyebrow: 'Why Bizdavar?', title: 'A full motorcycle gear catalog', desc: 'The price on the card is in US dollars, for delivery in Iran. If there is no price, we quote on request.' },
        buy: { eyebrow: 'Purchase path', title: 'From pick to dispatch — five steps', desc: 'Goods and postage are quoted separately. Both appear on the proforma before you pay.' },
        quote: { eyebrow: 'Quote guide', title: 'Send a clothing size or SKU', desc: 'For apparel, size, height and weight speed up the proforma.' },
        highlights: { eyebrow: 'High demand', title: 'From full-face helmets to touring boots', desc: 'Card prices are in US dollars, for delivery in Iran. No price means quote only.' },
        catalog: { eyebrow: 'Full catalog', title: 'Motorcycle gear', desc: '3,876 motorcycle products with real photos: helmets, jackets, gloves, pants, boots and intercoms.' },
        iran: { eyebrow: 'Use cases', title: 'Who is it for?', desc: 'Motorcycle shops, city riders, off-road and personal orders.', note: 'Missing a size? Send height and weight on WhatsApp.' },
        supply: { eyebrow: 'Supply by Bizdavar', title: 'Motorcycle supply services', desc: 'One contact for helmets, jackets, boots and the rest of the riding gear.' },
        faq: { eyebrow: 'FAQ', title: 'Price, postage and sizing', desc: 'No answer? Message us on WhatsApp.' }
      }, officialNote: 'Card prices are in US dollars for delivery in Iran. No price means quote only. For German engine oil see <a href="liqui-moly">Liqui Moly</a> · <a href="auto-moto">Auto-Moto</a> · <a href="car-parts">brake shop</a> · <a href="contact">contact</a>', cta: { title: 'Need a quote for a helmet, jacket or boots?', desc: 'Send a size or SKU. You get a proforma; postage is confirmed after the order.', btnForm: 'Quote form', btnServices: 'Product catalog' }, sticky: { label: 'Motorcycle gear quote', hint: 'US dollars, Iran delivery' }, geoText: 'Motorcycle gear supply — prices on the card are in US dollars, for delivery in Iran.', related: [{ title: 'Auto-Moto', desc: 'Two separate shops: gear and brakes' }, { title: 'Brake shop', desc: 'Pads and discs by brand and model' }, { title: 'Liqui Moly', desc: 'Oils and additives' }, { title: 'Contact', desc: 'Clothing size or SKU' }] }
    }
  };
