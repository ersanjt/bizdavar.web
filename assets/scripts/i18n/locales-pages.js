...
(function () {
  const serviceBlocks = {
    fa: [
      ...
      { title: 'تامین تجهیزات صنعتی', subtitle: 'Industrial Supply · VEGA · Prosense · Liqui Moly', body: 'تامین اصل VEGA، Prosense، Liqui Moly و Gamak برای پروژه‌های B2B — سنسور، دتکتور گاز، روغن خودرو، الکتروموتور، GPS و تجهیزات فروشگاهی. کاتالوگ: <a href="vega">VEGA</a> · <a href="prosense">Prosense</a> · <a href="liqui-moly">Liqui Moly</a> · <a href="gamak">Gamak</a> · <a href="teltonika">Teltonika</a>.', tags: ['SIL2/3', 'لجستیک', 'مشاوره فنی'], checks: ['<a href="vega">VEGA</a> — VEGAPULS 6X، VEGABAR، VEGAPOINT', '<a href="prosense">Prosense</a> — PQ، SafeVader، SOMA، PPS+', '<a href="liqui-moly">Liqui Moly</a> — روغن موتور، Octane Plus، افزودنی', '<a href="gamak">Gamak</a> — IE2/IE3/IE4، Ex-proof، فشار متوسط', '<a href="teltonika">Teltonika</a> — FMB920، FMC650، Fleet Telematics', '<a href="digi-system">Digi System</a> — POS و تجهیزات خرده‌فروشی', '<a href="teraoka">Teraoka</a> — ترازو و تجهیزات فروشگاهی', 'مشاوره فنی و انتخاب مدل', 'پیش‌فاکتور شفاف و لجستیک بین‌المللی'], cta: 'استعلام قیمت تجهیزات' }
    ],
    tr: [
  ...
  const page = {
    fa: {
      ...
      vegaPage: { sections: {
        ...
        faq: { eyebrow: 'سوالات متداول', title: 'پرسش‌های رایج خریداران ایرانی', desc: 'پاسخ سوال خود را پیدا نکردید؟ مستقیم با ما در تماس باشید.' }
      }, officialNote: 'اطلاعات فنی محصولات بر اساس <a href="https://www.vega.com/en-ae" target="_blank" rel="noopener noreferrer">وبسایت رسمی VEGA</a> است. برای استعلام قیمت، کد سفارش و تامین — <a href="contact">با بیزدوار تماس بگیرید</a>.', cta: { title: 'آماده استعلام قیمت VEGA هستید؟', desc: 'نام محصول یا شرایط فرآیند را بفرستید — مشاوره فنی رایگان و پیش‌فاکتور شفاف', btnForm: 'فرم استعلام', btnServices: 'خدمات صنعتی' }, sticky: { label: 'استعلام VEGA', hint: 'مشاوره فنی فارسی · پاسخ سریع' }, geoText: 'تامین اصل سنسور VEGA به ایران — مشاوره فنی فارسی از استانبول، پیش‌فاکتور شفاف و لجستیک تا پروژه‌های صنعتی ایران.', related: [{ title: 'محصولات Prosense', desc: 'دتکتور گاز و شعله' }, { title: 'خدمات صنعتی', desc: 'مشاوره و تامین' }, { title: 'تماس و استعلام', desc: 'مشاوره رایگان' }] },
      ...
      liquiMolyPage: { sections: {
        ...
        catalog: { eyebrow: 'کاتالوگ کامل', title: 'محصولات Liqui Moly با قیمت دلاری', desc: 'منبع قیمت: توزیع‌کننده ترکیه — تبدیل با نرخ ۱ دلار = ۴۷ لیر' },
        iran: { eyebrow: 'کاربرد', title: 'Liqui Moly برای چه کسانی؟', desc: 'تعمیرگاه، ناوگان، موتورسیکلت و مصرف شخصی — استعلام عمده هم پذیرفته می‌شود.' },
      ...
      }, rateNote: { strong: 'نرخ نمایشی:', body: '۱ USD = ۴۷ TRY · قیمت‌ها تقریبی‌اند و قبل از سفارش تایید می‌شوند · منبع:' }, officialNote: 'اطلاعات و قیمت‌ها بر اساس <a href="https://www.liquimolyturkey.com/" target="_blank" rel="noopener noreferrer">Liqui Moly Türkiye</a> است. برای سفارش — <a href="contact">تماس با بیزدوار</a> · <a href="vega">VEGA</a> · <a href="prosense">Prosense</a>', cta: { title: 'آماده سفارش Liqui Moly هستید؟', desc: 'نام محصول یا کد SKU را بفرستید — Octane Plus · Top Tec · Molygen · افزودنی دیزل', btnForm: 'فرم استعلام', btnServices: 'خدمات صنعتی' }, sticky: { label: 'استعلام Liqui Moly', hint: 'قیمت دلاری · مشاوره فارسی' }, geoText: 'تامین اصل Liqui Moly از ترکیه — قیمت دلاری شفاف (۱$=۴۷₺)، مشاوره فارسی و لجستیک برای روغن، افزودنی و مراقبت خودرو.', related: [{ title: 'محصولات VEGA', desc: 'سنسور سطح و فشار' }, { title: 'محصولات Prosense', desc: 'دتکتور گاز و شعله' }, { title: 'خدمات صنعتی', desc: 'مشاوره تامین B2B' }, { title: 'تماس', desc: 'استعلام قیمت' }] }
    },
    tr: {
      ...
      vegaPage: { sections: {
        ...
        faq: { eyebrow: 'SSS', title: 'Alıcıların sık sorduğu sorular', desc: 'Cevabı bulamadınız mı? Doğrudan bizimle iletişime geçin.' }
      }, officialNote: 'Ürünlerin teknik bilgileri <a href="https://www.vega.com/en-ae" target="_blank" rel="noopener noreferrer">resmi VEGA web sitesine</a> dayanır. Fiyat teklifi, sipariş kodu ve tedarik için — <a href="contact">Bizdavar ile iletişime geçin</a>.', cta: { title: 'VEGA fiyat teklifine hazır mısınız?', desc: 'Ürün adını veya proses koşullarını gönderin — ücretsiz teknik danışmanlık ve şeffaf proforma', btnForm: 'Teklif formu', btnServices: 'Endüstriyel hizmetler' }, sticky: { label: 'VEGA teklifi', hint: 'Türkçe teknik danışmanlık · hızlı yanıt' }, geoText: 'Orijinal VEGA sensör tedariki — İstanbul merkezli Türkçe teknik danışmanlık, şeffaf proforma ve endüstriyel projelere lojistik.', related: [{ title: 'Prosense ürünleri', desc: 'Gaz ve alev dedektörü' }, { title: 'Endüstriyel hizmetler', desc: 'Danışmanlık ve tedarik' }, { title: 'İletişim ve teklif', desc: 'Ücretsiz danışmanlık' }] },
      prosensePage: { sections: {
      ...
      liquiMolyPage: { sections: {
        ...
        catalog: { eyebrow: 'Tam katalog', title: 'Dolar fiyatlı Liqui Moly ürünleri', desc: 'Fiyat kaynağı: Türkiye dağıtıcısı — 1 USD = 47 TRY' },
        iran: { eyebrow: 'Uygulama', title: 'Liqui Moly kimler için?', desc: 'Servis, filo, motosiklet ve bireysel kullanım — toptan teklif de alınır.' },
      ...
      }, rateNote: { strong: 'Gösterim kuru:', body: '1 USD = 47 TRY · Fiyatlar yaklaşıktır ve sipariş öncesi onaylanır · Kaynak:' }, officialNote: 'Bilgi ve fiyatlar <a href="https://www.liquimolyturkey.com/" target="_blank" rel="noopener noreferrer">Liqui Moly Türkiye</a> kaynağına dayanır. Sipariş için — <a href="contact">Bizdavar</a> · <a href="vega">VEGA</a> · <a href="prosense">Prosense</a>', cta: { title: 'Liqui Moly siparişine hazır mısınız?', desc: 'Ürün adı veya SKU gönderin — Octane Plus · Top Tec · Molygen', btnForm: 'Teklif formu', btnServices: 'Endüstriyel hizmetler' }, sticky: { label: 'Liqui Moly teklifi', hint: 'Dolar fiyat · Farsça danışmanlık' }, geoText: 'Türkiye üzerinden orijinal Liqui Moly tedariki — şeffaf dolar fiyat (1$=47₺), Farsça danışmanlık ve lojistik.', related: [{ title: 'VEGA ürünleri', desc: 'Seviye ve basınç sensörleri' }, { title: 'Prosense ürünleri', desc: 'Gaz ve alev dedektörü' }, { title: 'Endüstriyel hizmetler', desc: 'B2B tedarik' }, { title: 'İletişim', desc: 'Fiyat teklifi' }] }
    },
    en: {
      ...
      vegaPage: { sections: {
        ...
        faq: { eyebrow: 'FAQ', title: 'Common questions from buyers', desc: 'Didn’t find your answer? Contact us directly.' }
      }, officialNote: 'Product technical information is based on the <a href="https://www.vega.com/en-ae" target="_blank" rel="noopener noreferrer">official VEGA website</a>. For pricing, order codes and supply — <a href="contact">contact Bizdavar</a>.', cta: { title: 'Ready for a VEGA quote?', desc: 'Send the product name or process conditions — free technical consulting and a transparent proforma', btnForm: 'Quote form', btnServices: 'Industrial services' }, sticky: { label: 'VEGA quote', hint: 'Multilingual consulting · fast reply' }, geoText: 'Genuine VEGA sensor supply to Iran — multilingual technical consulting from Istanbul, transparent proforma and logistics to industrial projects.', related: [{ title: 'Prosense products', desc: 'Gas and flame detectors' }, { title: 'Industrial services', desc: 'Consulting and supply' }, { title: 'Contact and inquiry', desc: 'Free consultation' }] },
      prosensePage: { sections: {
      ...
      liquiMolyPage: { sections: {
        ...
        catalog: { eyebrow: 'Full catalog', title: 'Liqui Moly products with USD prices', desc: 'Price source: Turkey distributor — converted at 1 USD = 47 TRY' },
        iran: { eyebrow: 'Use cases', title: 'Who is Liqui Moly for?', desc: 'Workshops, fleets, motorcycles and personal use — bulk quotes welcome.' },
      ...
      }, rateNote: { strong: 'Display rate:', body: '1 USD = 47 TRY · Prices are approximate and confirmed before order · Source:' }, officialNote: 'Information and prices are based on <a href="https://www.liquimolyturkey.com/" target="_blank" rel="noopener noreferrer">Liqui Moly Türkiye</a>. To order — <a href="contact">contact Bizdavar</a> · <a href="vega">VEGA</a> · <a href="prosense">Prosense</a>', cta: { title: 'Ready to order Liqui Moly?', desc: 'Send product name or SKU — Octane Plus · Top Tec · Molygen · diesel additives', btnForm: 'Quote form', btnServices: 'Industrial services' }, sticky: { label: 'Liqui Moly quote', hint: 'USD pricing · Farsi consulting' }, geoText: 'Genuine Liqui Moly from Turkey — transparent USD pricing (1$=47₺), Farsi consulting and logistics for oils, additives and car care.', related: [{ title: 'VEGA products', desc: 'Level and pressure sensors' }, { title: 'Prosense products', desc: 'Gas and flame detectors' }, { title: 'Industrial services', desc: 'B2B supply consulting' }, { title: 'Contact', desc: 'Price inquiry' }] }
    }
  };
