  ...
  const page = {
    ...
    tr: {
      ...
      uwtPage: { sections: {
        ...
        buy: { eyebrow: 'Satınalma yolu', title: 'Tekliften teslimata — 5 net adım', desc: 'Karmaşa yok — her adımı bilir ve her aşamada iletişimde olursunuz.' },
        highlights: { eyebrow: 'En çok talep edilenler', title: 'Projeler için öne çıkan UWT serileri', desc: 'Rotonivo · Vibranivo · NivoRadar · NivoGuide — her seri için “Teklif iste”.' },
        catalog: { eyebrow: 'Tam katalog', title: 'UWT seviye ölçümü kataloğu', desc: 'Seviye şalteri, temassız radar, kılavuzlu radar ve yerel gösterge' },
        iran: { eyebrow: 'Bölgesel uygulama', title: 'UWT yaygın endüstrilerde', desc: 'Sektörünüz listede yoksa — malzeme türü ve silo yüksekliğini gönderin.' },
        industries: { eyebrow: 'Küresel endüstriler', title: 'Farklı endüstrilerde uygulama', desc: 'UWT seviye sensörleri — dökme katı ve sıvılar' },
        supply: { eyebrow: 'Bizdavar tedariki', title: 'UWT tedarik hizmetleri', desc: 'Tedarik ortağınız — sadece satıcı değil' },
        faq: { eyebrow: 'SSS', title: 'Alıcıların sık sorduğu sorular', desc: 'Cevabı bulamadınız mı? Doğrudan bizimle iletişime geçin.' }
      }, officialNote: 'Teknik bilgiler <a href="https://www.uwtgroup.com/en/" target="_blank" rel="noopener noreferrer">resmi UWT web sitesine</a> dayanır. Teklif için — <a href="contact">Bizdavar</a> · <a href="vega">VEGA</a> · <a href="prosense">Prosense</a>', cta: { title: 'UWT fiyat teklifine hazır mısınız?', desc: 'Malzeme, silo yüksekliği ve dolu/boş noktasını gönderin — Rotonivo · Vibranivo · NivoRadar', btnForm: 'Teklif formu', btnServices: 'Ürün kataloğu' }, sticky: { label: 'UWT teklifi' }, geoText: 'Almanya’dan UWT seviye sensör tedariki — teknik danışmanlık, proforma ve lojistik Bizdavar Group.', related: [{ title: 'VEGA kataloğu', desc: 'Seviye ve basınç' }, { title: 'Prosense', desc: 'Gaz ve alev dedektörü' }, { title: 'Ürün kataloğu', desc: 'Tedarik markaları' }, { title: 'İletişim', desc: 'Ücretsiz danışmanlık' }] },
      digiSystemPage: { sections: {
    ...
    en: {
      ...
      uwtPage: { sections: {
        trust: { eyebrow: 'Why buy from Bizdavar?', title: 'Reliable UWT supply for your technical and procurement teams', desc: 'We do more than show a catalog — from paddle or radar selection to delivery.' },
        buy: { eyebrow: 'Purchase path', title: 'From quote to delivery — 5 clear steps', desc: 'No complexity — you know every step and stay in touch throughout.' },
        highlights: { eyebrow: 'High-demand', title: 'Featured UWT series for regional projects', desc: 'Rotonivo · Vibranivo · NivoRadar · NivoGuide — use “Request quote” for each series.' },
        catalog: { eyebrow: 'Full catalog', title: 'UWT level measurement catalog', desc: 'Point level, non-contact radar, guided radar and local visualisation' },
        iran: { eyebrow: 'Regional application', title: 'UWT across common industries', desc: 'If your industry isn’t listed — send medium type and silo height.' },
        industries: { eyebrow: 'Global industries', title: 'Application across industries', desc: 'UWT level sensors for bulk solids and liquids' },
        supply: { eyebrow: 'Supply by Bizdavar', title: 'UWT supply services', desc: 'Your supply partner — not just a vendor' },
        faq: { eyebrow: 'FAQ', title: 'Common questions from buyers', desc: 'Didn’t find your answer? Contact us directly.' }
      }, officialNote: 'Technical information is based on the <a href="https://www.uwtgroup.com/en/" target="_blank" rel="noopener noreferrer">official UWT website</a>. For quotes — <a href="contact">contact Bizdavar</a> · <a href="vega">VEGA</a> · <a href="prosense">Prosense</a>', cta: { title: 'Ready for a UWT quote?', desc: 'Send medium, silo height and full/empty point — Rotonivo · Vibranivo · NivoRadar', btnForm: 'Quote form', btnServices: 'Product catalog' }, sticky: { label: 'UWT quote' }, geoText: 'UWT level sensors from Germany — multilingual consulting, proforma and logistics by Bizdavar Group.', related: [{ title: 'VEGA catalog', desc: 'Level and pressure' }, { title: 'Prosense', desc: 'Gas and flame detectors' }, { title: 'Product catalog', desc: 'Supply brands' }, { title: 'Contact', desc: 'Free consultation' }] },
      digiSystemPage: { sections: {
