...
(function () {
  const serviceBlocks = {
    fa: [
      ...
      { title: 'تامین تجهیزات صنعتی', subtitle: 'Industrial Supply · B2B', body: 'مشاوره و تامین تجهیزات صنعتی شامل سنسورها، دتکتور گاز، GPS ناوگان، پمپ‌ها، موتور و ابزار دقیق. کاتالوگ: <a href="vega.html">VEGA</a> · <a href="prosense.html">Prosense</a> · <a href="teltonika.html">Teltonika</a> · <a href="gamak.html">Gamak</a>.', tags: ['SIL2/3', 'لجستیک', 'مشاوره فنی'], checks: ['<a href="vega.html">سنسورهای VEGA</a> — VEGAPULS، VEGABAR، VEGAPOINT', '<a href="prosense.html">Prosense</a> — PQ، SafeVader، SOMA، PPS+', '<a href="teltonika.html">Teltonika</a> — FMB920، FMC650، Fleet Telematics', '<a href="gamak.html">الکتروموتور Gamak</a> — موتورهای صنعتی ترکیه', '<a href="digi-system.html">Digi System</a> — POS و تجهیزات خرده‌فروشی', '<a href="teraoka.html">Teraoka Seiko</a> — ترازو و تجهیزات فروشگاهی', 'مشاوره فنی و انتخاب تجهیز', 'تامین و لجستیک بین‌المللی'], cta: 'استعلام قیمت تجهیزات' }
    ],
    tr: [
      { title: 'Dijital pazarlama', subtitle: 'Digital Marketing · Strateji ve kampanya yönetimi', body: 'Bizdavar Group modern dijital pazarlama stratejileriyle dönüşüm oranını ve online satışı artırır. İlgili yazı: <a href="articles/digital-marketing.html">Dijital pazarlama satışları nasıl artırır?</a>', tags: ['Google Ads', 'SEO', 'CRO', 'Otomasyon'], checks: ['Rakip ve hedef kitle analizi', 'Google ve sosyal medya kampanyaları', 'Dönüşüm oranı optimizasyonu (CRO)', 'Pazarlama otomasyonu ve e-posta', 'Performans raporlama ve analiz'], cta: 'Danışmanlık iste' },
  ...
  const page = {
    fa: {
      ...
      digiSystemPage: { sections: {
        ...
        faq: { eyebrow: 'سوالات متداول', title: 'پرسش‌های رایج خریداران ایرانی', desc: 'پاسخ سوال خود را پیدا نکردید؟ مستقیم با ما در تماس باشید.' }
      }, officialNote: 'اطلاعات فنی بر اساس <a href="https://www.digisystem.com.tr/" target="_blank" rel="noopener noreferrer">وبسایت رسمی Digi System</a> است. برای استعلام — <a href="contact.html">با بیزدوار تماس بگیرید</a> · <a href="teraoka.html">Teraoka</a>', cta: { title: 'آماده استعلام قیمت Digi System هستید؟', desc: 'نوع فروشگاه، تعداد صندوق و نیاز ترازو legal-for-trade را بفرستید', btnForm: 'فرم استعلام', btnServices: 'خدمات صنعتی' }, sticky: { label: 'استعلام Digi System' }, geoText: 'تامین Digi System از ترکیه به ایران — مشاوره فارسی، پیش‌فاکتور و لجستیک توسط بیزدوار گروپ.', related: [{ title: 'Teraoka Seiko', desc: 'ترازو و POS ژاپن' }, { title: 'خدمات صنعتی', desc: 'تامین retail B2B' }, { title: 'تماس', desc: 'استعلام قیمت' }] },
      teraokaPage: { sections: {
        ...
        faq: { eyebrow: 'سوالات متداول', title: 'پرسش‌های رایج خریداران ایرانی', desc: 'پاسخ سوال خود را پیدا نکردید؟ مستقیم با ما در تماس باشید.' }
      }, officialNote: 'اطلاعات فنی بر اساس <a href="https://www.teraoka.co.jp/" target="_blank" rel="noopener noreferrer">وبسایت رسمی Teraoka Seiko</a> است. برای استعلام — <a href="contact.html">با بیزدوار تماس بگیرید</a> · <a href="digi-system.html">Digi System</a>', cta: { title: 'آماده استعلام قیمت Teraoka هستید؟', desc: 'نوع ترازو، ظرفیت و تعداد صندوق را بفرستید — deli · POS · labeling', btnForm: 'فرم استعلام', btnServices: 'خدمات صنعتی' }, sticky: { label: 'استعلام Teraoka' }, geoText: 'تامین Teraoka Seiko به ایران — مشاوره فارسی، پیش‌فاکتور و لجستیک بین‌المللی توسط بیزدوار گروپ.', related: [{ title: 'Digi System', desc: 'ترازو و POS ترکیه' }, { title: 'خدمات صنعتی', desc: 'تامین retail B2B' }, { title: 'تماس', desc: 'استعلام قیمت' }] },
      fastPage: { sections: { plans: { eyebrow: 'پلن‌های قیمت', title: 'پلن مناسب کسب‌وکار خود را انتخاب کنید', desc: 'قیمت ثابت، بدون هزینه پنهان — سفارش از واتساپ یا <a href="contact.html">فرم تماس</a>.' }, compare: { eyebrow: 'مقایسه پلن‌ها', title: 'چه چیزی در هر پلن می‌گیرید؟', desc: 'برای انتخاب بین پلن‌ها — این جدول را ببینید یا در واتساپ بپرسید.' }, timeline: { eyebrow: 'مسیر اجرا', title: '۵ روز تا آنلاین شدن — مرحله به مرحله', desc: 'هر روز هدف مشخص دارد و در واتساپ گزارش پیشرفت می‌دهیم.' }, why: { eyebrow: 'چرا Fast؟', title: 'چرا Fast Web Studio؟', desc: 'محصولی از <a href="about.html">بیزدوار گروپ</a> — نه آژانس عمومی با وعده‌های مبهم.' }, showcase: { eyebrow: 'نمونه‌کارها', title: 'سایت‌هایی که با بیزدوار ساخته شده‌اند', desc: 'نمونه پروژه‌های طراحی وب — <a href="portfolio.html">مشاهده همه نمونه‌کارها</a>' }, faq: { eyebrow: 'سوالات متداول', title: 'پرسش‌های رایج قبل از سفارش', desc: '' } }, cta: { title: 'آماده راه‌اندازی سایت هستید؟', desc: 'مشاوره رایگان در واتساپ — پلن مناسب را در ۲ دقیقه پیشنهاد می‌دهیم.', btnWa: 'شروع در واتساپ', btnForm: 'فرم تماس', btnCustom: 'پروژه اختصاصی' }, sticky: { label: 'سفارش Fast — از $99' }, geoText: 'طراحی سایت برای کسب‌وکارهای ایران، ترکیه و بازارهای بین‌المللی — تحویل ۵ روزه، واتساپ فارسی و پشتیبانی پس از راه‌اندازی.' },
      vegaPage: { sections: {
        ...
        faq: { eyebrow: 'سوالات متداول', title: 'پرسش‌های رایج خریداران ایرانی', desc: 'پاسخ سوال خود را پیدا نکردید؟ مستقیم با ما در تماس باشید.' }
      }, officialNote: 'اطلاعات فنی محصولات بر اساس <a href="https://www.vega.com/en-ae" target="_blank" rel="noopener noreferrer">وبسایت رسمی VEGA</a> است. برای استعلام قیمت، کد سفارش و تامین — <a href="contact.html">با بیزدوار تماس بگیرید</a>.', cta: { title: 'آماده استعلام قیمت VEGA هستید؟', desc: 'نام محصول یا شرایط فرآیند را بفرستید — مشاوره فنی رایگان و پیش‌فاکتور شفاف', btnForm: 'فرم استعلام', btnServices: 'خدمات صنعتی' }, sticky: { label: 'استعلام VEGA' }, geoText: 'تامین اصل سنسور VEGA به ایران — مشاوره فنی فارسی از استانبول، پیش‌فاکتور شفاف و لجستیک تا پروژه‌های صنعتی ایران.' },
      prosensePage: { sections: {
        ...
        faq: { eyebrow: 'سوالات متداول', title: 'پرسش‌های رایج خریداران ایرانی', desc: 'پاسخ سوال خود را پیدا نکردید؟ مستقیم با ما در تماس باشید.' }
      }, officialNote: 'اطلاعات فنی محصولات بر اساس <a href="https://www.prosense.com.tr/?lang=tr" target="_blank" rel="noopener noreferrer">وبسایت رسمی Prosense</a> است. برای استعلام قیمت و تامین — <a href="contact.html">با بیزدوار تماس بگیرید</a> · <a href="vega.html">محصولات VEGA</a>', cta: { title: 'آماده استعلام قیمت Prosense هستید؟', desc: 'نوع گاز یا سری مدل را بفرستید — PQ · SafeVader · SOMA · PPS+ · پنل S-DPX', btnForm: 'فرم استعلام', btnServices: 'خدمات صنعتی' }, sticky: { label: 'استعلام Prosense' }, geoText: 'تامین اصل دتکتور Prosense به ایران — گواهی SIL/M1/EN، مشاوره فارسی و تحویل برای پروژه‌های نفت، گاز و صنعت.' },
    ...
    tr: {
      ...
      teraokaPage: { sections: {
        ...
        faq: { eyebrow: 'SSS', title: 'Alıcıların sık sorduğu sorular', desc: 'Cevabı bulamadınız mı? Doğrudan bizimle iletişime geçin.' }
      }, officialNote: 'Teknik bilgiler <a href="https://www.teraoka.co.jp/" target="_blank" rel="noopener noreferrer">resmi Teraoka Seiko</a> sitesine dayanır. Teklif için — <a href="contact.html">Bizdavar</a> · <a href="digi-system.html">Digi System</a>', cta: { title: 'Teraoka fiyat teklifine hazır mısınız?', desc: 'Terazi türü, kapasite ve kasa sayısını gönderin — deli · POS · etiketleme', btnForm: 'Teklif formu', btnServices: 'Endüstriyel hizmetler' }, sticky: { label: 'Teraoka teklifi' }, geoText: 'Teraoka Seiko tedariki İran ve bölgeye — Farsça danışmanlık, proforma ve uluslararası lojistik Bizdavar tarafından.', related: [{ title: 'Digi System', desc: 'Türkiye terazi ve POS' }, { title: 'Endüstriyel hizmetler', desc: 'Perakende B2B tedarik' }, { title: 'İletişim', desc: 'Fiyat teklifi' }] },
      fastPage: { sections: { plans: { eyebrow: 'Fiyat planları', title: 'İşletmeniz için doğru planı seçin', desc: 'Sabit fiyat, gizli maliyet yok — WhatsApp veya <a href="contact.html">iletişim formu</a> ile sipariş.' }, compare: { eyebrow: 'Plan karşılaştırması', title: 'Her planda neler var?', desc: 'Plan seçmek için tabloyu inceleyin veya WhatsApp’tan sorun.' }, timeline: { eyebrow: 'Uygulama yolu', title: '5 günde yayına — adım adım', desc: 'Her gün net hedef ve WhatsApp üzerinden ilerleme raporu.' }, why: { eyebrow: 'Neden Fast?', title: 'Neden Fast Web Studio?', desc: '<a href="about.html">Bizdavar Group</a> ürünü — belirsiz vaatler veren genel bir ajans değil.' }, showcase: { eyebrow: 'Örnek işler', title: 'Bizdavar ile yapılan web siteleri', desc: 'Web tasarım örnekleri — <a href="portfolio.html">tüm portfolyoyu gör</a>' }, faq: { eyebrow: 'SSS', title: 'Sipariş öncesi sık sorulanlar', desc: '' } }, cta: { title: 'Web sitenizi başlatmaya hazır mısınız?', desc: 'WhatsApp’ta ücretsiz danışmanlık — uygun planı 2 dakikada önerelim.', btnWa: 'WhatsApp’ta başla', btnForm: 'İletişim formu', btnCustom: 'Özel proje' }, sticky: { label: 'Fast siparişi — $99’dan başlayan' }, geoText: 'İran, Türkiye ve uluslararası pazarlardaki işletmeler için web tasarımı — 5 günde teslim, Farsça WhatsApp ve lansman sonrası destek.' },
      vegaPage: { sections: {
        ...
        faq: { eyebrow: 'SSS', title: 'Alıcıların sık sorduğu sorular', desc: 'Cevabı bulamadınız mı? Doğrudan bizimle iletişime geçin.' }
      }, officialNote: 'Ürünlerin teknik bilgileri <a href="https://www.vega.com/en-ae" target="_blank" rel="noopener noreferrer">resmi VEGA web sitesine</a> dayanır. Fiyat teklifi, sipariş kodu ve tedarik için — <a href="contact.html">Bizdavar ile iletişime geçin</a>.', cta: { title: 'VEGA fiyat teklifine hazır mısınız?', desc: 'Ürün adını veya proses koşullarını gönderin — ücretsiz teknik danışmanlık ve şeffaf proforma', btnForm: 'Teklif formu', btnServices: 'Endüstriyel hizmetler' }, sticky: { label: 'VEGA teklifi' }, geoText: 'İran’a orijinal VEGA sensör tedariki — İstanbul’dan Farsça teknik danışmanlık, şeffaf proforma ve endüstriyel projelere lojistik.' },
      prosensePage: { sections: {
        ...
        faq: { eyebrow: 'SSS', title: 'Alıcıların sık sorduğu sorular', desc: 'Cevabı bulamadınız mı? Doğrudan bizimle iletişime geçin.' }
      }, officialNote: 'Ürünlerin teknik bilgileri <a href="https://www.prosense.com.tr/?lang=tr" target="_blank" rel="noopener noreferrer">resmi Prosense web sitesine</a> dayanır. Fiyat teklifi ve tedarik için — <a href="contact.html">Bizdavar ile iletişime geçin</a> · <a href="vega.html">VEGA ürünleri</a>', cta: { title: 'Prosense fiyat teklifine hazır mısınız?', desc: 'Gaz türünü veya model serisini gönderin — PQ · SafeVader · SOMA · PPS+ · S-DPX paneli', btnForm: 'Teklif formu', btnServices: 'Endüstriyel hizmetler' }, sticky: { label: 'Prosense teklifi' }, geoText: 'İran’a orijinal Prosense dedektör tedariki — SIL/M1/EN sertifikaları, Farsça danışmanlık ve petrol, gaz ve endüstri projeleri için teslimat.' },
      teltonikaPage: { sections: {
    ...
    en: {
      ...
      digiSystemPage: { sections: {
        ...
        faq: { eyebrow: 'FAQ', title: 'Common questions from buyers', desc: 'Didn’t find your answer? Contact us directly.' }
      }, officialNote: 'Technical information is based on the <a href="https://www.digisystem.com.tr/" target="_blank" rel="noopener noreferrer">official Digi System website</a>. For quotes — <a href="contact.html">contact Bizdavar</a> · <a href="teraoka.html">Teraoka</a>', cta: { title: 'Ready for a Digi System quote?', desc: 'Send store type, checkout count and legal-for-trade scale needs', btnForm: 'Quote form', btnServices: 'Industrial services' }, sticky: { label: 'Digi System quote' }, geoText: 'Digi System supply from Turkey to Iran — Persian consulting, proforma and logistics by Bizdavar Group.', related: [{ title: 'Teraoka Seiko', desc: 'Japanese scales and POS' }, { title: 'Industrial services', desc: 'Retail B2B supply' }, { title: 'Contact', desc: 'Price inquiry' }] },
      teraokaPage: { sections: {
        ...
        faq: { eyebrow: 'FAQ', title: 'Common questions from buyers', desc: 'Didn’t find your answer? Contact us directly.' }
      }, officialNote: 'Technical information is based on the <a href="https://www.teraoka.co.jp/" target="_blank" rel="noopener noreferrer">official Teraoka Seiko website</a>. For quotes — <a href="contact.html">contact Bizdavar</a> · <a href="digi-system.html">Digi System</a>', cta: { title: 'Ready for a Teraoka quote?', desc: 'Send scale type, capacity and checkout count — deli · POS · labeling', btnForm: 'Quote form', btnServices: 'Industrial services' }, sticky: { label: 'Teraoka quote' }, geoText: 'Teraoka Seiko supply to Iran — Persian consulting, proforma and international logistics by Bizdavar Group.', related: [{ title: 'Digi System', desc: 'Turkish scales and POS' }, { title: 'Industrial services', desc: 'Retail B2B supply' }, { title: 'Contact', desc: 'Price inquiry' }] },
      fastPage: { sections: { plans: { eyebrow: 'Pricing plans', title: 'Choose the right plan for your business', desc: 'Fixed pricing, no hidden costs — order through WhatsApp or the <a href="contact.html">contact form</a>.' }, compare: { eyebrow: 'Plan comparison', title: 'What do you get in each plan?', desc: 'Use this table to choose a plan or ask us on WhatsApp.' }, timeline: { eyebrow: 'Delivery path', title: '5 days to go live — step by step', desc: 'Each day has a clear goal and progress is reported on WhatsApp.' }, why: { eyebrow: 'Why Fast?', title: 'Why Fast Web Studio?', desc: 'A <a href="about.html">Bizdavar Group</a> product — not a generic agency with vague promises.' }, showcase: { eyebrow: 'Showcase', title: 'Websites built with Bizdavar', desc: 'Web design examples — <a href="portfolio.html">view the full portfolio</a>' }, faq: { eyebrow: 'FAQ', title: 'Common questions before ordering', desc: '' } }, cta: { title: 'Ready to launch your website?', desc: 'Free WhatsApp consultation — we suggest the right plan in 2 minutes.', btnWa: 'Start on WhatsApp', btnForm: 'Contact form', btnCustom: 'Custom project' }, sticky: { label: 'Order Fast — from $99' }, geoText: 'Web design for businesses in Iran, Turkey and international markets — 5-day delivery, Persian WhatsApp and post-launch support.' },
      vegaPage: { sections: {
      ...
      prosensePage: { sections: {
        ...
        faq: { eyebrow: 'FAQ', title: 'Common questions from buyers', desc: 'Didn’t find your answer? Contact us directly.' }
      }, officialNote: 'Product technical information is based on the <a href="https://www.prosense.com.tr/?lang=tr" target="_blank" rel="noopener noreferrer">official Prosense website</a>. For pricing and supply — <a href="contact.html">contact Bizdavar</a> · <a href="vega.html">VEGA products</a>', cta: { title: 'Ready for a Prosense quote?', desc: 'Send the gas type or model series — PQ · SafeVader · SOMA · PPS+ · S-DPX panel', btnForm: 'Quote form', btnServices: 'Industrial services' }, sticky: { label: 'Prosense quote' }, geoText: 'Genuine Prosense detector supply to Iran — SIL/M1/EN certifications, Persian consulting and delivery for oil, gas and industrial projects.' },
      teltonikaPage: { sections: {
  ...
  const caseStudy = {
    fa: {
      biztejarat: {
        ...
        products: { title: 'محصولات معرفی‌شده در صفحه', desc: 'نمونه حوزه‌هایی که در محتوای بیزتجارت پوشش داده می‌شود — تامین فنی از طریق <a href="services.html#industrial">بیزدوار گروپ</a>' },
    ...
    tr: {
      biztejarat: {
        ...
        products: { title: 'Sayfada tanıtılan ürünler', desc: 'Biztejarat içeriğinde kapsanan alan örnekleri — teknik tedarik <a href="services.html#industrial">Bizdavar Group</a> üzerinden' },
    ...
    en: {
      biztejarat: {
        ...
        products: { title: 'Products featured on the page', desc: 'Examples of areas covered in Biztejarat content — technical supply via <a href="services.html#industrial">Bizdavar Group</a>' },
