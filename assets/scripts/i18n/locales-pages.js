  ...
  const page = {
    fa: {
      ...
      autoMotoPage: { sections: {
        trust: { eyebrow: 'چرا از بیزدوار بخرید؟', title: 'کاتالوگ کامل تجهیزات موتورسیکلت', desc: 'قیمت روی کارت به دلار و برای تحویل در ایران است. اگر قیمت نباشد، فقط استعلام است.' },
    ...
    tr: {
      ...
      autoMotoPage: { sections: {
        trust: { eyebrow: 'Neden Bizdavar?', title: 'Tam motosiklet ekipmanı kataloğu', desc: 'Kart fiyatı İran teslimi için dolardır. Fiyat yoksa yalnızca teklif.' },
    ...
    en: {
      ...
      autoMotoPage: { sections: {
        trust: { eyebrow: 'Why Bizdavar?', title: 'A full motorcycle gear catalog', desc: 'Card prices are USD for delivery in Iran. If there is no price, request a quote.' },
