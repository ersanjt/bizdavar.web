...
window.FAST_CATALOG = {
  ...
  faq: [
    ...
    { q: 'هاست و دامنه شامل قیمت است؟', a: 'هزینه طراحی و راه‌اندازی جداست. دامنه و هاست سالانه را می‌توانید خودتان بخرید یا با راهنمایی ما انجام دهید. SSL رایگان روی اکثر هاست‌ها فعال می‌شود.' },
