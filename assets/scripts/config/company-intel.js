...
window.BIZDAVAR_INTEL = {
  ...
  identity: {
    ...
    headquarters: [
      { city: 'استانبول', country: 'ترکیه', role: 'عملیات بین‌المللی و فین‌تک' },
  ...
  activityAreas: [
    ...
    },
    {
      id: 'infrastructure',
      title: 'زیرساخت',
      items: ['هاستینگ ابری NetinoHost', 'مدیریت دامنه و DNS', 'SSL و امنیت', 'پشتیبانی فنی']
    }
  ],
  ...
  faqIntel: [
    ...
    { q: 'آیا بیزدوار فقط طراحی سایت انجام می‌دهد؟', a: 'خیر. علاوه بر Fast Web Studio و طراحی حرفه‌ای، بازاریابی دیجیتال، مدیریت زیرساخت (NetinoHost)، فین‌تک و تامین VEGA/Prosense نیز در حوزه فعالیت است.' },
