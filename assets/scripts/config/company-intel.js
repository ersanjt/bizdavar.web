...
window.BIZDAVAR_INTEL = {
    ...
    headquarters: [
      {
        city: 'تبریز',
        country: 'ایران',
        role: 'دفتر ایران · تکنولوژی پردازان توسعه خاورمیانه',
        badge: 'IR'
      },
      {
        city: 'استانبول',
        country: 'ترکیه',
        role: 'دفتر ترکیه · فین‌تک و عملیات بین‌المللی',
        badge: 'TR'
      },
      {
        city: 'ایروان',
        country: 'ارمنستان',
        role: 'دفتر ارمنستان · Bizdavar Group LLC',
        badge: 'AM'
      },
      {
        city: 'دبی',
        country: 'امارات',
        role: 'دفتر دبی · عملیات منطقه‌ای',
        badge: 'AE'
      }
    ],
  ...
  leadership: {
    founder: {
      ...
      bioFa: 'بیش از ۱۳ سال تجربه در طراحی و توسعه ۱۰۰+ وبسایت و پلتفرم سفارشی. بنیان‌گذار بیزدوار گروپ و رهبر پروژه‌های دیجیتال در ۱۱ کشور — از فین‌تک و پرداخت تا صنعت و هاستینگ ابری.'
    },
  ...
  ecosystem: [
    ...
    { name: 'BizPad', type: 'محصول پد حرارتی', note: 'پد حرارتی پدیده ۱۳۹۹ — خانه و خودرو؛ نام فروشگاهی BizSeat همان این کالاست' },
  ...
  /** حضور جغرافیایی */
  presence: {
    countries: ['ترکیه', 'امارات', 'آلمان', 'آمریکا', 'انگلستان', 'ارمنستان', 'لبنان', 'ایران', 'عراق', 'گرجستان', 'ایتالیا', 'روسیه', 'چین', 'کانادا', 'استرالیا'],
    summaryFa: 'پروژه‌های اجراشده در ۱۵ کشور — دفاتر در ایران، ترکیه، ارمنستان و دبی.',
    mapImage: 'assets/images/content/presence-map.svg?v=3',
    stats: [
      { value: '۱۵', label: 'کشور فعال' },
      { value: '۴', label: 'دفتر عملیاتی' },
      { value: '+۱۰۰', label: 'پروژه بین‌المللی' }
    ],
    istanbulHub: {
      title: 'دفتر ترکیه — استانبول',
      subtitle: 'Bizdavar Group — Turkey office',
      city: 'استانبول',
      country: 'ترکیه',
      ...
      intro: 'دفتر ترکیه بیزدوار گروپ در استانبول — یکی از چهار دفتر عملیاتی ما (ایران، ترکیه، ارمنستان و دبی). پوشش پروژه‌های دیجیتال، فین‌تک و تامین صنعتی B2B با مشاوره چندزبانه، پیش‌فاکتور و لجستیک بین‌المللی.',
      services: [
        'فین‌تک و پلتفرم‌های پرداخت (ZedPay و اکوسیستم)',
        'طراحی وب و Fast Web Studio',
        'بازاریابی دیجیتال، سئو و SMM',
        'تامین VEGA، Prosense، Gamak و تجهیزات صنعتی',
        'دامنه، هاست، SSL و زیرساخت (Netinode)',
        'هماهنگی پروژه‌های منطقه‌ای'
      ],
      note: 'برای مشتریان فارسی‌زبان — واتساپ فارسی (+98 930 588 0135). خط ترکیه برای پروژه‌های محلی.'
    },
    yerevanHub: {
    ...
    regions: [
        ...
        countries: [
          {
            ...
            hub: true,
            city: 'استانبول',
            focus: 'دفتر ترکیه · فین‌تک · وب · تامین صنعتی',
            detail: 'یکی از دفاتر عملیاتی — مشاوره فارسی/ترکی/انگلیسی'
          },
          { name: 'ایران', hub: true, city: 'تبریز', focus: 'شخصیت حقوقی · دیجیتال و صنعت', detail: 'تکنولوژی پردازان توسعه خاورمیانه — آذربایجان شرقی' },
          { name: 'امارات', hub: true, city: 'دبی', focus: 'دفتر دبی · تجارت و فین‌تک', detail: 'یکی از چهار دفتر عملیاتی بیزدوار' },
      ...
      },
      {
        ...
        countries: [
          ...
          { name: 'روسیه', focus: 'پروژه‌های بین‌الملل' }
        ]
      },
      {
        id: 'americas',
        ...
        countries: [
          ...
          { name: 'کانادا', focus: 'پروژه‌های دیجیتال' }
        ]
      },
      {
        id: 'asia-pacific',
        title: 'آسیا و اقیانوسیه',
        countries: [
          { name: 'چین', focus: 'تامین و تجارت' },
          { name: 'استرالیا', focus: 'پروژه‌های بین‌الملل' }
        ]
      }
    ]
  },
  ...
  verifiedSources: [
    ...
    },
    {
      ...
      items: [
        ...
        {
          label: 'دیجی‌کالا — BizPad / پشتی خودرو بیزدوار (dkp-7694589)',
          ...
          note: 'همان پد حرارتی BizPad — عرضه فروشگاهی ۱۳۹۹'
        },
        {
  ...
  faqIntel: [
    ...
    { q: 'بیزدوار در چه کشورهایی پروژه اجرا کرده؟', a: 'پروژه‌ها در ۱۵ کشور شامل ترکیه، امارات، آلمان، آمریکا، انگلستان، ارمنستان، لبنان، ایران، عراق، گرجستان، ایتالیا، روسیه، چین، کانادا و استرالیا انجام شده است.' },
