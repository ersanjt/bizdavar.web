...
(function () {
  ...
  window.DIGI_SYSTEM_CATALOG = {
    brand: {
      ...
      descriptionFa: 'بیزدوار گروپ تامین‌کننده ترازو، صندوق فروشگاهی و سیستم POS برند Digi System (DIGI) برای سوپرمارکت، deli، نانوایی و زنجیره‌های retail در ایران است. انتخاب مدل رسمی (SM-6000، W-5600SRX، LX-5600، AW-5600)، مشاوره فنی و لجستیک .',
      heroStats: [
    ...
    purchaseSteps: [
      ...
      { num: '۴', title: 'تامین', desc: 'سفارش رسمی — بسته‌بندی و حمل ' },
