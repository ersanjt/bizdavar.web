...
(function () {
  ...
  window.AUTO_MOTO_CATALOG = {
    ...
    brand: {
      ...
      descriptionFa: 'بیزدوار گروپ تجهیزات موتورسیکلت را تامین می‌کند. قیمت روی کارت دلاری و برای تحویل ایران است: لیر فهرست روز تقسیم بر ۴۸، به‌اضافه ۲۰ درصد. لیر نمایش داده نمی‌شود. اگر قیمت نباشد فقط استعلام است.',
      heroStats: [
        { value: String(products.length) + '+', label: 'محصول در کاتالوگ' },
        { value: 'USD', label: 'تحویل ایران' },
        { value: '۱۱', label: 'دسته موتور' }
      ]
    },
    trustSignals: [
      { icon: 'coin', label: 'قیمت دلاری تحویل ایران', desc: 'لیر فهرست ÷ ۴۸، به‌اضافه ۲۰ درصد. لیر روی کارت نیست' },
    ...
    whyBuyFromUs: [
      { icon: 'document', title: 'پیش‌فاکتور قبل از پرداخت', desc: 'قیمت موتور روی کارت دلاری تحویل ایران است (÷۴۸ و ۲۰٪). اگر قیمت نباشد استعلام است. مبلغ نهایی در پیش‌فاکتور تایید می‌شود.' },
    ...
    faq: [
      { q: 'قیمت روی کارت نهایی است؟', a: 'قیمت موتور دلاری و برای تحویل ایران است: لیر فهرست روز تقسیم بر ۴۸، به‌اضافه ۲۰ درصد. لیر نمایش داده نمی‌شود. اگر قیمت نباشد فقط استعلام است. مبلغ نهایی در پیش‌فاکتور تایید می‌شود.' },
