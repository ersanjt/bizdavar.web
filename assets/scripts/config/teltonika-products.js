  ...
  window.TELTONIKA_CATALOG = {
    ...
    whyBuyFromUs: [
      ...
      },
      {
        ...
        desc: 'حمل‌ونقل، لجستیک، کرایه خودرو، معدن، کشاورزی، توزیع سوخت و ناوگان سازمانی — با پشتیبانی فارسی — دفاتر ایران، ترکیه، ارمنستان و دبی.'
      },
      {
        icon: 'document',
    ...
    services: [
      ...
      { title: 'لجستیک بین‌المللی', desc: 'لجستیک بین‌المللی تا تحویل در مقصد پروژه' },
