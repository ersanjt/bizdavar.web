...
(function () {
  ...
  const ICONS = {
    ...
    send: `<path fill="currentColor" stroke="none" d="M2.2 21.2L22.5 12.4c.7-.3.7-1.3 0-1.6L2.2 1.9c-.7-.3-1.4.3-1.2 1.1L3.3 10c.1.4.4.6.8.7l9.2 1.3c.3 0 .3.4 0 .5L4.1 13.8c-.4.1-.7.3-.8.7l-2.3 6.9c-.2.8.5 1.4 1.2 1.1z"/>`,
